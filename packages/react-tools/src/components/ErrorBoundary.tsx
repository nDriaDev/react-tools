...
/**
 * **`ErrorBoundary`**: Wrapper component that lets you display some fallback UI when your application throws an error during rendering. [See demo](https://nDriaDev.io/react-tools/#/components/ErrorBoundary)
 * @param {Object} props
