...
/**
 * **`useDebounce`**: Hook to delay a function execution with possibility to cancel execution and to invoke them immediately. [See demo](https://nDriaDev.io/react-tools/#/hooks/api-dom/useDebounce)
