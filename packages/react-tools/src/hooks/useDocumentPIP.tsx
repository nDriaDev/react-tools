...
import { useEffectOnce, useRerender } from ".";

/**
 * **`useDocumentPIP`**: Hook to use Document PIP [(Document-Picture-in-Picture API)](https://developer.mozilla.org/en-US/docs/Web/API/Document_Picture-in-Picture_API).
