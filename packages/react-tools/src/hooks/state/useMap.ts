...
/**
 * __`useMap`__: Hook to use _Map data structure_ to handle component state with all Map methods. [See demo](https://nDriaDev.io/react-tools/#/hooks/state/useMap)
