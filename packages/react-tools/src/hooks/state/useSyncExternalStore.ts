...
/**
 * __`useSyncExternalStore`__: _useSyncExternalStore_ hook polyfilled for React versions below 18 ___only client side___. [See demo](https://nDriaDev.io/react-tools/#/hooks/state/useSyncExternalStore)
