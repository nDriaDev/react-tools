...
/**
 * **`useEffectCompare`**: custom useEffect that reexecutes EffectCallback only when comparator function, received as third parameter, returns true. [See demo](https://nDriaDev.io/react-tools/#/hooks/lifecycle/useEffectCompare)
