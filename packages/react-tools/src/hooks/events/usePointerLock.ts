...
/**
 * **`usePointerLock`**: Hook to use [PointerLock API](https://developer.mozilla.org/en-US/docs/Web/API/Pointer_Lock_API). [See demo](https://nDriaDev.io/react-tools/#/hooks/events/usePointerLock)
