...
`,...a.current()});return/^[\t ]/.test(l)&&(l="&#x"+l.charCodeAt(0).toString(16).toUpperCase()+";"+l.slice(1)),l=l?i+" "+l:i,n.options.closeAtx&&(l+=" "+i),c(),s(),l}vy.peek=QD;function vy(e){return e.value||""}function QD(){return"<"}yy.peek=YD;function yy(e,t,n,o){const r=Mp(n),a=r==='"'?"Quote":"Apostrophe",i=n.enter("image");let s=n.enter("label");const c=n.createTracker(o);let l=c.move("![");return l+=c.move(n.safe(e.alt,{before:l,after:"]",...c.current()})),l+=c.move("]("),s(),!e.url&&e.title||/[\0- \u007F]/.test(e.url)?(s=n.enter("destinationLiteral"),l+=c.move("<"),l+=c.move(n.safe(e.url,{before:l,after:">",...c.current()})),l+=c.move(">")):(s=n.enter("destinationRaw"),l+=c.move(n.safe(e.url,{before:l,after:e.title?" ":")",...c.current()}))),s(),e.title&&(s=n.enter(`title${a}`),l+=c.move(" "+r),l+=c.move(n.safe(e.title,{before:l,after:r,...c.current()})),l+=c.move(r),s()),l+=c.move(")"),i(),l}function YD(){return"!"}ky.peek=XD;function ky(e,t,n,o){const r=e.referenceType,a=n.enter("imageReference");let i=n.enter("label");const s=n.createTracker(o);let c=s.move("![");const l=n.safe(e.alt,{before:c,after:"]",...s.current()});c+=s.move(l+"]["),i();const d=n.stack;n.stack=[],i=n.enter("reference");const p=n.safe(n.associationId(e),{before:c,after:"]",...s.current()});return i(),n.stack=d,a(),r==="full"||!l||l!==p?c+=s.move(p+"]"):r==="shortcut"?c=c.slice(0,-1):c+=s.move("]"),c}function XD(){return"!"}wy.peek=JD;function wy(e,t,n){let o=e.value||"",r="`",a=-1;for(;new RegExp("(^|[^`])"+r+"([^`]|$)").test(o);)r+="`";for(/[^ \r\n]/.test(o)&&(/^[ \r\n]/.test(o)&&/[ \r\n]$/.test(o)||/^`|`$/.test(o))&&(o=" "+o+" ");++a<n.unsafe.length;){const i=n.unsafe[a],s=n.compilePattern(i);let c;if(i.atBreak)for(;c=s.exec(o);){let l=c.index;o.charCodeAt(l)===10&&o.charCodeAt(l-1)===13&&l--,o=o.slice(0,l)+" "+o.slice(c.index+1)}}return r+o+r}function JD(){return"`"}function Sy(e,t){const n=ip(e);return!!(!t.options.resourceLink&&e.url&&!e.title&&e.children&&e.children.length===1&&e.children[0].type==="text"&&(n===e.url||"mailto:"+n===e.url)&&/^[a-z][a-z+.-]+:/i.test(e.url)&&!/[\0- <>\u007F]/.test(e.url))}xy.peek=ZD;function xy(e,t,n,o){const r=Mp(n),a=r==='"'?"Quote":"Apostrophe",i=n.createTracker(o);let s,c;if(Sy(e,n)){const d=n.stack;n.stack=[],s=n.enter("autolink");let p=i.move("<");return p+=i.move(n.containerPhrasing(e,{before:p,after:">",...i.current()})),p+=i.move(">"),s(),n.stack=d,p}s=n.enter("link"),c=n.enter("label");let l=i.move("[");return l+=i.move(n.containerPhrasing(e,{before:l,after:"](",...i.current()})),l+=i.move("]("),c(),!e.url&&e.title||/[\0- \u007F]/.test(e.url)?(c=n.enter("destinationLiteral"),l+=i.move("<"),l+=i.move(n.safe(e.url,{before:l,after:">",...i.current()})),l+=i.move(">")):(c=n.enter("destinationRaw"),l+=i.move(n.safe(e.url,{before:l,after:e.title?" ":")",...i.current()}))),c(),e.title&&(c=n.enter(`title${a}`),l+=i.move(" "+r),l+=i.move(n.safe(e.title,{before:l,after:r,...i.current()})),l+=i.move(r),c()),l+=i.move(")"),s(),l}function ZD(e,t,n){return Sy(e,n)?"<":"["}Cy.peek=e5;function Cy(e,t,n,o){const r=e.referenceType,a=n.enter("linkReference");let i=n.enter("label");const s=n.createTracker(o);let c=s.move("[");const l=n.containerPhrasing(e,{before:c,after:"]",...s.current()});c+=s.move(l+"]["),i();const d=n.stack;n.stack=[],i=n.enter("reference");const p=n.safe(n.associationId(e),{before:c,after:"]",...s.current()});return i(),n.stack=d,a(),r==="full"||!l||l!==p?c+=s.move(p+"]"):r==="shortcut"?c=c.slice(0,-1):c+=s.move("]"),c}function e5(){return"["}function jp(e){const t=e.options.bullet||"*";if(t!=="*"&&t!=="+"&&t!=="-")throw new Error("Cannot serialize items with `"+t+"` for `options.bullet`, expected `*`, `+`, or `-`");return t}function t5(e){const t=jp(e),n=e.options.bulletOther;if(!n)return t==="*"?"-":"*";if(n!=="*"&&n!=="+"&&n!=="-")throw new Error("Cannot serialize items with `"+n+"` for `options.bulletOther`, expected `*`, `+`, or `-`");if(n===t)throw new Error("Expected `bullet` (`"+t+"`) and `bulletOther` (`"+n+"`) to be different");return n}function n5(e){const t=e.options.bulletOrdered||".";if(t!=="."&&t!==")")throw new Error("Cannot serialize items with `"+t+"` for `options.bulletOrdered`, expected `.` or `)`");return t}function Ey(e){const t=e.options.rule||"*";if(t!=="*"&&t!=="-"&&t!=="_")throw new Error("Cannot serialize rules with `"+t+"` for `options.rule`, expected `*`, `-`, or `_`");return t}function o5(e,t,n,o){const r=n.enter("list"),a=n.bulletCurrent;let i=e.ordered?n5(n):jp(n);const s=e.ordered?i==="."?")":".":t5(n);let c=t&&n.bulletLastUsed?i===n.bulletLastUsed:!1;if(!e.ordered){const d=e.children?e.children[0]:void 0;if((i==="*"||i==="-")&&d&&(!d.children||!d.children[0])&&n.stack[n.stack.length-1]==="list"&&n.stack[n.stack.length-2]==="listItem"&&n.stack[n.stack.length-3]==="list"&&n.stack[n.stack.length-4]==="listItem"&&n.indexStack[n.indexStack.length-1]===0&&n.indexStack[n.indexStack.length-2]===0&&n.indexStack[n.indexStack.length-3]===0&&(c=!0),Ey(n)===i&&d){let p=-1;for(;++p<e.children.length;){const f=e.children[p];if(f&&f.type==="listItem"&&f.children&&f.children[0]&&f.children[0].type==="thematicBreak"){c=!0;break}}}}c&&(i=s),n.bulletCurrent=i;const l=n.containerFlow(e,o);return n.bulletLastUsed=i,n.bulletCurrent=a,r(),l}function r5(e){const t=e.options.listItemIndent||"one";if(t!=="tab"&&t!=="one"&&t!=="mixed")throw new Error("Cannot serialize items with `"+t+"` for `options.listItemIndent`, expected `tab`, `one`, or `mixed`");return t}function a5(e,t,n,o){const r=r5(n);let a=n.bulletCurrent||jp(n);t&&t.type==="list"&&t.ordered&&(a=(typeof t.start=="number"&&t.start>-1?t.start:1)+(n.options.incrementListMarker===!1?0:t.children.indexOf(e))+a);let i=a.length+1;(r==="tab"||r==="mixed"&&(t&&t.type==="list"&&t.spread||e.spread))&&(i=Math.ceil(i/4)*4);const s=n.createTracker(o);s.move(a+" ".repeat(i-a.length)),s.shift(i);const c=n.enter("listItem"),l=n.indentLines(n.containerFlow(e,s.current()),d);return c(),l;function d(p,f,h){return f?(h?"":" ".repeat(i))+p:(h?a:a+" ".repeat(i-a.length))+p}}function i5(e,t,n,o){const r=n.enter("paragraph"),a=n.enter("phrasing"),i=n.containerPhrasing(e,o);return a(),r(),i}const l5=Bl(["break","delete","emphasis","footnote","footnoteReference","image","imageReference","inlineCode","link","linkReference","strong","text"]);function s5(e,t,n,o){return(e.children.some(function(i){return l5(i)})?n.containerPhrasing:n.containerFlow).call(n,e,o)}function c5(e){const t=e.options.strong||"*";if(t!=="*"&&t!=="_")throw new Error("Cannot serialize strong with `"+t+"` for `options.strong`, expected `*`, or `_`");return t}Ty.peek=u5;function Ty(e,t,n,o){const r=c5(n),a=n.enter("strong"),i=n.createTracker(o);let s=i.move(r+r);return s+=i.move(n.containerPhrasing(e,{before:s,after:r,...i.current()})),s+=i.move(r+r),a(),s}function u5(e,t,n){return n.options.strong||"*"}function d5(e,t,n,o){return n.safe(e.value,o)}function p5(e){const t=e.options.ruleRepetition||3;if(t<3)throw new Error("Cannot serialize rules with repetition `"+t+"` for `options.ruleRepetition`, expected `3` or more");return t}function f5(e,t,n){const o=(Ey(n)+(n.options.ruleSpaces?" ":"")).repeat(p5(n));return n.options.ruleSpaces?o.slice(0,-1):o}const Ay={blockquote:LD,break:vg,code:WD,definition:VD,emphasis:by,hardBreak:vg,heading:KD,html:vy,image:yy,imageReference:ky,inlineCode:wy,link:xy,linkReference:Cy,list:o5,listItem:a5,paragraph:i5,root:s5,strong:Ty,text:d5,thematicBreak:f5};function h5(){return{enter:{table:m5,tableData:yg,tableHeader:yg,tableRow:_5},exit:{codeText:b5,table:g5,tableData:Hc,tableHeader:Hc,tableRow:Hc}}}function m5(e){const t=e._align;this.enter({type:"table",align:t.map(function(n){return n==="none"?null:n}),children:[]},e),this.data.inTable=!0}function g5(e){this.exit(e),this.data.inTable=void 0}function _5(e){this.enter({type:"tableRow",children:[]},e)}function Hc(e){this.exit(e)}function yg(e){this.enter({type:"tableCell",children:[]},e)}function b5(e){let t=this.resume();this.data.inTable&&(t=t.replace(/\\([\\|])/g,v5));const n=this.stack[this.stack.length-1];n.type,n.value=t,this.exit(e)}function v5(e,t){return t==="|"?t:e}function y5(e){const t=e||{},n=t.tableCellPadding,o=t.tablePipeAlign,r=t.stringLength,a=n?" ":"|";return{unsafe:[{character:"\r",inConstruct:"tableCell"},{character:`
...
`))}function c(h,v,k,T){const b=k.enter("tableCell"),m=k.enter("phrasing"),g=k.containerPhrasing(h,{...T,before:a,after:a});return m(),b(),g}function l(h,v){return jD(h,{align:v,alignDelimiters:o,padding:n,stringLength:r})}function d(h,v,k){const T=h.children;let b=-1;const m=[],g=v.enter("table");for(;++b<T.length;)m[b]=p(T[b],v,k);return g(),m}function p(h,v,k){const T=h.children;let b=-1;const m=[],g=v.enter("tableRow");for(;++b<T.length;)m[b]=c(T[b],h,v,k);return g(),m}function f(h,v,k){let T=Ay.inlineCode(h,v,k);return k.stack.includes("tableCell")&&(T=T.replace(/\|/g,"\\$&")),T}}function k5(){return{exit:{taskListCheckValueChecked:kg,taskListCheckValueUnchecked:kg,paragraph:S5}}}function w5(){return{unsafe:[{atBreak:!0,character:"-",after:"[:|-]"}],handlers:{listItem:x5}}}function kg(e){const t=this.stack[this.stack.length-2];t.type,t.checked=e.type==="taskListCheckValueChecked"}function S5(e){const t=this.stack[this.stack.length-2];if(t&&t.type==="listItem"&&typeof t.checked=="boolean"){const n=this.stack[this.stack.length-1];n.type;const o=n.children[0];if(o&&o.type==="text"){const r=t.children;let a=-1,i;for(;++a<r.length;){const s=r[a];if(s.type==="paragraph"){i=s;break}}i===n&&(o.value=o.value.slice(1),o.value.length===0?n.children.shift():n.position&&o.position&&typeof o.position.start.offset=="number"&&(o.position.start.column++,o.position.start.offset++,n.position.start=Object.assign({},o.position.start)))}}this.exit(e)}function x5(e,t,n,o){const r=e.children[0],a=typeof e.checked=="boolean"&&r&&r.type==="paragraph",i="["+(e.checked?"x":" ")+"] ",s=n.createTracker(o);a&&s.move(i);let c=Ay.listItem(e,t,n,{...o,...s.current()});return a&&(c=c.replace(/^(?:[*+-]|\d+\.)([\r\n]| {1,3})/,l)),c;function l(d){return d+i}}function C5(){return[nD(),hD(),AD(),h5(),k5()]}function E5(e){return{extensions:[oD(),mD(),PD(),y5(e),w5()]}}const T5={tokenize:j5,partial:!0},Py={tokenize:z5,partial:!0},Ry={tokenize:O5,partial:!0},Dy={tokenize:L5,partial:!0},A5={tokenize:I5,partial:!0},My={tokenize:D5,previous:zy},jy={tokenize:M5,previous:Oy},jn={tokenize:R5,previous:Ly},mn={};function P5(){return{text:mn}}let go=48;for(;go<123;)mn[go]=jn,go++,go===58?go=65:go===91&&(go=97);mn[43]=jn;mn[45]=jn;mn[46]=jn;mn[95]=jn;mn[72]=[jn,jy];mn[104]=[jn,jy];mn[87]=[jn,My];mn[119]=[jn,My];function R5(e,t,n){const o=this;let r,a;return i;function i(p){return!Zu(p)||!Ly.call(o,o.previous)||zp(o.events)?n(p):(e.enter("literalAutolink"),e.enter("literalAutolinkEmail"),s(p))}function s(p){return Zu(p)?(e.consume(p),s):p===64?(e.consume(p),c):n(p)}function c(p){return p===46?e.check(A5,d,l)(p):p===45||p===95||it(p)?(a=!0,e.consume(p),c):d(p)}function l(p){return e.consume(p),r=!0,c}function d(p){return a&&r&&ut(o.previous)?(e.exit("literalAutolinkEmail"),e.exit("literalAutolink"),t(p)):n(p)}}function D5(e,t,n){const o=this;return r;function r(i){return i!==87&&i!==119||!zy.call(o,o.previous)||zp(o.events)?n(i):(e.enter("literalAutolink"),e.enter("literalAutolinkWww"),e.check(T5,e.attempt(Py,e.attempt(Ry,a),n),n)(i))}function a(i){return e.exit("literalAutolinkWww"),e.exit("literalAutolink"),t(i)}}function M5(e,t,n){const o=this;let r="",a=!1;return i;function i(p){return(p===72||p===104)&&Oy.call(o,o.previous)&&!zp(o.events)?(e.enter("literalAutolink"),e.enter("literalAutolinkHttp"),r+=String.fromCodePoint(p),e.consume(p),s):n(p)}function s(p){if(ut(p)&&r.length<5)return r+=String.fromCodePoint(p),e.consume(p),s;if(p===58){const f=r.toLowerCase();if(f==="http"||f==="https")return e.consume(p),c}return n(p)}function c(p){return p===47?(e.consume(p),a?l:(a=!0,c)):n(p)}function l(p){return p===null||gl(p)||Ee(p)||zo(p)||Nl(p)?n(p):e.attempt(Py,e.attempt(Ry,d),n)(p)}function d(p){return e.exit("literalAutolinkHttp"),e.exit("literalAutolink"),t(p)}}function j5(e,t,n){let o=0;return r;function r(i){return(i===87||i===119)&&o<3?(o++,e.consume(i),r):i===46&&o===3?(e.consume(i),a):n(i)}function a(i){return i===null?n(i):t(i)}}function z5(e,t,n){let o,r,a;return i;function i(l){return l===46||l===95?e.check(Dy,c,s)(l):l===null||Ee(l)||zo(l)||l!==45&&Nl(l)?c(l):(a=!0,e.consume(l),i)}function s(l){return l===95?o=!0:(r=o,o=void 0),e.consume(l),i}function c(l){return r||o||!a?n(l):t(l)}}function O5(e,t){let n=0,o=0;return r;function r(i){return i===40?(n++,e.consume(i),r):i===41&&o<n?a(i):i===33||i===34||i===38||i===39||i===41||i===42||i===44||i===46||i===58||i===59||i===60||i===63||i===93||i===95||i===126?e.check(Dy,t,a)(i):i===null||Ee(i)||zo(i)?t(i):(e.consume(i),r)}function a(i){return i===41&&o++,e.consume(i),r}}function L5(e,t,n){return o;function o(s){return s===33||s===34||s===39||s===41||s===42||s===44||s===46||s===58||s===59||s===63||s===95||s===126?(e.consume(s),o):s===38?(e.consume(s),a):s===93?(e.consume(s),r):s===60||s===null||Ee(s)||zo(s)?t(s):n(s)}function r(s){return s===null||s===40||s===91||Ee(s)||zo(s)?t(s):o(s)}function a(s){return ut(s)?i(s):n(s)}function i(s){return s===59?(e.consume(s),o):ut(s)?(e.consume(s),i):n(s)}}function I5(e,t,n){return o;function o(a){return e.consume(a),r}function r(a){return it(a)?n(a):t(a)}}function zy(e){return e===null||e===40||e===42||e===95||e===91||e===93||e===126||Ee(e)}function Oy(e){return!ut(e)}function Ly(e){return!(e===47||Zu(e))}function Zu(e){return e===43||e===45||e===46||e===95||it(e)}function zp(e){let t=e.length,n=!1;for(;t--;){const o=e[t][1];if((o.type==="labelLink"||o.type==="labelImage")&&!o._balanced){n=!0;break}if(o._gfmAutolinkLiteralWalkedInto){n=!1;break}}return e.length>0&&!n&&(e[e.length-1][1]._gfmAutolinkLiteralWalkedInto=!0),n}const F5={tokenize:q5,partial:!0};function U5(){return{document:{91:{tokenize:B5,continuation:{tokenize:V5},exit:$5}},text:{91:{tokenize:W5},93:{add:"after",tokenize:N5,resolveTo:H5}}}}function N5(e,t,n){const o=this;let r=o.events.length;const a=o.parser.gfmFootnotes||(o.parser.gfmFootnotes=[]);let i;for(;r--;){const c=o.events[r][1];if(c.type==="labelImage"){i=c;break}if(c.type==="gfmFootnoteCall"||c.type==="labelLink"||c.type==="label"||c.type==="image"||c.type==="link")break}return s;function s(c){if(!i||!i._balanced)return n(c);const l=tn(o.sliceSerialize({start:i.end,end:o.now()}));return l.codePointAt(0)!==94||!a.includes(l.slice(1))?n(c):(e.enter("gfmFootnoteCallLabelMarker"),e.consume(c),e.exit("gfmFootnoteCallLabelMarker"),t(c))}}function H5(e,t){let n=e.length;for(;n--;)if(e[n][1].type==="labelImage"&&e[n][0]==="enter"){e[n][1];break}e[n+1][1].type="data",e[n+3][1].type="gfmFootnoteCallLabelMarker";const o={type:"gfmFootnoteCall",start:Object.assign({},e[n+3][1].start),end:Object.assign({},e[e.length-1][1].end)},r={type:"gfmFootnoteCallMarker",start:Object.assign({},e[n+3][1].end),end:Object.assign({},e[n+3][1].end)};r.end.column++,r.end.offset++,r.end._bufferIndex++;const a={type:"gfmFootnoteCallString",start:Object.assign({},r.end),end:Object.assign({},e[e.length-1][1].start)},i={type:"chunkString",contentType:"string",start:Object.assign({},a.start),end:Object.assign({},a.end)},s=[e[n+1],e[n+2],["enter",o,t],e[n+3],e[n+4],["enter",r,t],["exit",r,t],["enter",a,t],["enter",i,t],["exit",i,t],["exit",a,t],e[e.length-2],e[e.length-1],["exit",o,t]];return e.splice(n,e.length-n+1,...s),e}function W5(e,t,n){const o=this,r=o.parser.gfmFootnotes||(o.parser.gfmFootnotes=[]);let a=0,i;return s;function s(p){return e.enter("gfmFootnoteCall"),e.enter("gfmFootnoteCallLabelMarker"),e.consume(p),e.exit("gfmFootnoteCallLabelMarker"),c}function c(p){return p!==94?n(p):(e.enter("gfmFootnoteCallMarker"),e.consume(p),e.exit("gfmFootnoteCallMarker"),e.enter("gfmFootnoteCallString"),e.enter("chunkString").contentType="string",l)}function l(p){if(a>999||p===93&&!i||p===null||p===91||Ee(p))return n(p);if(p===93){e.exit("chunkString");const f=e.exit("gfmFootnoteCallString");return r.includes(tn(o.sliceSerialize(f)))?(e.enter("gfmFootnoteCallLabelMarker"),e.consume(p),e.exit("gfmFootnoteCallLabelMarker"),e.exit("gfmFootnoteCall"),t):n(p)}return Ee(p)||(i=!0),a++,e.consume(p),p===92?d:l}function d(p){return p===91||p===92||p===93?(e.consume(p),a++,l):l(p)}}function B5(e,t,n){const o=this,r=o.parser.gfmFootnotes||(o.parser.gfmFootnotes=[]);let a,i=0,s;return c;function c(v){return e.enter("gfmFootnoteDefinition")._container=!0,e.enter("gfmFootnoteDefinitionLabel"),e.enter("gfmFootnoteDefinitionLabelMarker"),e.consume(v),e.exit("gfmFootnoteDefinitionLabelMarker"),l}function l(v){return v===94?(e.enter("gfmFootnoteDefinitionMarker"),e.consume(v),e.exit("gfmFootnoteDefinitionMarker"),e.enter("gfmFootnoteDefinitionLabelString"),e.enter("chunkString").contentType="string",d):n(v)}function d(v){if(i>999||v===93&&!s||v===null||v===91||Ee(v))return n(v);if(v===93){e.exit("chunkString");const k=e.exit("gfmFootnoteDefinitionLabelString");return a=tn(o.sliceSerialize(k)),e.enter("gfmFootnoteDefinitionLabelMarker"),e.consume(v),e.exit("gfmFootnoteDefinitionLabelMarker"),e.exit("gfmFootnoteDefinitionLabel"),f}return Ee(v)||(s=!0),i++,e.consume(v),v===92?p:d}function p(v){return v===91||v===92||v===93?(e.consume(v),i++,d):d(v)}function f(v){return v===58?(e.enter("definitionMarker"),e.consume(v),e.exit("definitionMarker"),r.includes(a)||r.push(a),_e(e,h,"gfmFootnoteDefinitionWhitespace")):n(v)}function h(v){return t(v)}}function V5(e,t,n){return e.check($a,t,e.attempt(F5,t,n))}function $5(e){e.exit("gfmFootnoteDefinition")}function q5(e,t,n){const o=this;return _e(e,r,"gfmFootnoteDefinitionIndent",4+1);function r(a){const i=o.events[o.events.length-1];return i&&i[1].type==="gfmFootnoteDefinitionIndent"&&i[2].sliceSerialize(i[1],!0).length===4?t(a):n(a)}}function G5(e){let n=(e||{}).singleTilde;const o={tokenize:a,resolveAll:r};return n==null&&(n=!0),{text:{126:o},insideSpan:{null:[o]},attentionMarkers:{null:[126]}};function r(i,s){let c=-1;for(;++c<i.length;)if(i[c][0]==="enter"&&i[c][1].type==="strikethroughSequenceTemporary"&&i[c][1]._close){let l=c;for(;l--;)if(i[l][0]==="exit"&&i[l][1].type==="strikethroughSequenceTemporary"&&i[l][1]._open&&i[c][1].end.offset-i[c][1].start.offset===i[l][1].end.offset-i[l][1].start.offset){i[c][1].type="strikethroughSequence",i[l][1].type="strikethroughSequence";const d={type:"strikethrough",start:Object.assign({},i[l][1].start),end:Object.assign({},i[c][1].end)},p={type:"strikethroughText",start:Object.assign({},i[l][1].end),end:Object.assign({},i[c][1].start)},f=[["enter",d,s],["enter",i[l][1],s],["exit",i[l][1],s],["enter",p,s]],h=s.parser.constructs.insideSpan.null;h&&At(f,f.length,0,Hl(h,i.slice(l+1,c),s)),At(f,f.length,0,[["exit",p,s],["enter",i[c][1],s],["exit",i[c][1],s],["exit",d,s]]),At(i,l-1,c-l+3,f),c=l+f.length-2;break}}for(c=-1;++c<i.length;)i[c][1].type==="strikethroughSequenceTemporary"&&(i[c][1].type="data");return i}function a(i,s,c){const l=this.previous,d=this.events;let p=0;return f;function f(v){return l===126&&d[d.length-1][1].type!=="characterEscape"?c(v):(i.enter("strikethroughSequenceTemporary"),h(v))}function h(v){const k=_l(l);if(v===126)return p>1?c(v):(i.consume(v),p++,h);if(p<2&&!n)return c(v);const T=i.exit("strikethroughSequenceTemporary"),b=_l(v);return T._open=!b||b===2&&!!k,T._close=!k||k===2&&!!b,s(v)}}}class K5{constructor(){this.map=[]}add(t,n,o){Q5(this,t,n,o)}consume(t){if(this.map.sort(function(a,i){return a[0]-i[0]}),this.map.length===0)return;let n=this.map.length;const o=[];for(;n>0;)n-=1,o.push(t.slice(this.map[n][0]+this.map[n][1]),this.map[n][2]),t.length=this.map[n][0];o.push([...t]),t.length=0;let r=o.pop();for(;r;)t.push(...r),r=o.pop();this.map.length=0}}function Q5(e,t,n,o){let r=0;if(!(n===0&&o.length===0)){for(;r<e.map.length;){if(e.map[r][0]===t){e.map[r][1]+=n,e.map[r][2].push(...o);return}r+=1}e.map.push([t,n,o])}}function Y5(e,t){let n=!1;const o=[];for(;t<e.length;){const r=e[t];if(n){if(r[0]==="enter")r[1].type==="tableContent"&&o.push(e[t+1][1].type==="tableDelimiterMarker"?"left":"none");else if(r[1].type==="tableContent"){if(e[t-1][1].type==="tableDelimiterMarker"){const a=o.length-1;o[a]=o[a]==="left"?"center":"right"}}else if(r[1].type==="tableDelimiterRow")break}else r[0]==="enter"&&r[1].type==="tableDelimiterRow"&&(n=!0);t+=1}return o}function X5(){return{flow:{null:{tokenize:J5,resolveAll:Z5}}}}function J5(e,t,n){const o=this;let r=0,a=0,i;return s;function s(E){let N=o.events.length-1;for(;N>-1;){const re=o.events[N][1].type;if(re==="lineEnding"||re==="linePrefix")N--;else break}const F=N>-1?o.events[N][1].type:null,Y=F==="tableHead"||F==="tableRow"?w:c;return Y===w&&o.parser.lazy[o.now().line]?n(E):Y(E)}function c(E){return e.enter("tableHead"),e.enter("tableRow"),l(E)}function l(E){return E===124||(i=!0,a+=1),d(E)}function d(E){return E===null?n(E):te(E)?a>1?(a=0,o.interrupt=!0,e.exit("tableRow"),e.enter("lineEnding"),e.consume(E),e.exit("lineEnding"),h):n(E):me(E)?_e(e,d,"whitespace")(E):(a+=1,i&&(i=!1,r+=1),E===124?(e.enter("tableCellDivider"),e.consume(E),e.exit("tableCellDivider"),i=!0,d):(e.enter("data"),p(E)))}function p(E){return E===null||E===124||Ee(E)?(e.exit("data"),d(E)):(e.consume(E),E===92?f:p)}function f(E){return E===92||E===124?(e.consume(E),p):p(E)}function h(E){return o.interrupt=!1,o.parser.lazy[o.now().line]?n(E):(e.enter("tableDelimiterRow"),i=!1,me(E)?_e(e,v,"linePrefix",o.parser.constructs.disable.null.includes("codeIndented")?void 0:4)(E):v(E))}function v(E){return E===45||E===58?T(E):E===124?(i=!0,e.enter("tableCellDivider"),e.consume(E),e.exit("tableCellDivider"),k):x(E)}function k(E){return me(E)?_e(e,T,"whitespace")(E):T(E)}function T(E){return E===58?(a+=1,i=!0,e.enter("tableDelimiterMarker"),e.consume(E),e.exit("tableDelimiterMarker"),b):E===45?(a+=1,b(E)):E===null||te(E)?_(E):x(E)}function b(E){return E===45?(e.enter("tableDelimiterFiller"),m(E)):x(E)}function m(E){return E===45?(e.consume(E),m):E===58?(i=!0,e.exit("tableDelimiterFiller"),e.enter("tableDelimiterMarker"),e.consume(E),e.exit("tableDelimiterMarker"),g):(e.exit("tableDelimiterFiller"),g(E))}function g(E){return me(E)?_e(e,_,"whitespace")(E):_(E)}function _(E){return E===124?v(E):E===null||te(E)?!i||r!==a?x(E):(e.exit("tableDelimiterRow"),e.exit("tableHead"),t(E)):x(E)}function x(E){return n(E)}function w(E){return e.enter("tableRow"),A(E)}function A(E){return E===124?(e.enter("tableCellDivider"),e.consume(E),e.exit("tableCellDivider"),A):E===null||te(E)?(e.exit("tableRow"),t(E)):me(E)?_e(e,A,"whitespace")(E):(e.enter("data"),R(E))}function R(E){return E===null||E===124||Ee(E)?(e.exit("data"),A(E)):(e.consume(E),E===92?j:R)}function j(E){return E===92||E===124?(e.consume(E),R):R(E)}}function Z5(e,t){let n=-1,o=!0,r=0,a=[0,0,0,0],i=[0,0,0,0],s=!1,c=0,l,d,p;const f=new K5;for(;++n<e.length;){const h=e[n],v=h[1];h[0]==="enter"?v.type==="tableHead"?(s=!1,c!==0&&(wg(f,t,c,l,d),d=void 0,c=0),l={type:"table",start:Object.assign({},v.start),end:Object.assign({},v.end)},f.add(n,0,[["enter",l,t]])):v.type==="tableRow"||v.type==="tableDelimiterRow"?(o=!0,p=void 0,a=[0,0,0,0],i=[0,n+1,0,0],s&&(s=!1,d={type:"tableBody",start:Object.assign({},v.start),end:Object.assign({},v.end)},f.add(n,0,[["enter",d,t]])),r=v.type==="tableDelimiterRow"?2:d?3:1):r&&(v.type==="data"||v.type==="tableDelimiterMarker"||v.type==="tableDelimiterFiller")?(o=!1,i[2]===0&&(a[1]!==0&&(i[0]=i[1],p=Ci(f,t,a,r,void 0,p),a=[0,0,0,0]),i[2]=n)):v.type==="tableCellDivider"&&(o?o=!1:(a[1]!==0&&(i[0]=i[1],p=Ci(f,t,a,r,void 0,p)),a=i,i=[a[1],n,0,0])):v.type==="tableHead"?(s=!0,c=n):v.type==="tableRow"||v.type==="tableDelimiterRow"?(c=n,a[1]!==0?(i[0]=i[1],p=Ci(f,t,a,r,n,p)):i[1]!==0&&(p=Ci(f,t,i,r,n,p)),r=0):r&&(v.type==="data"||v.type==="tableDelimiterMarker"||v.type==="tableDelimiterFiller")&&(i[3]=n)}for(c!==0&&wg(f,t,c,l,d),f.consume(t.events),n=-1;++n<t.events.length;){const h=t.events[n];h[0]==="enter"&&h[1].type==="table"&&(h[1]._align=Y5(t.events,n))}return e}function Ci(e,t,n,o,r,a){const i=o===1?"tableHeader":o===2?"tableDelimiter":"tableData",s="tableContent";n[0]!==0&&(a.end=Object.assign({},Go(t.events,n[0])),e.add(n[0],0,[["exit",a,t]]));const c=Go(t.events,n[1]);if(a={type:i,start:Object.assign({},c),end:Object.assign({},c)},e.add(n[1],0,[["enter",a,t]]),n[2]!==0){const l=Go(t.events,n[2]),d=Go(t.events,n[3]),p={type:s,start:Object.assign({},l),end:Object.assign({},d)};if(e.add(n[2],0,[["enter",p,t]]),o!==2){const f=t.events[n[2]],h=t.events[n[3]];if(f[1].end=Object.assign({},h[1].end),f[1].type="chunkText",f[1].contentType="text",n[3]>n[2]+1){const v=n[2]+1,k=n[3]-n[2]-1;e.add(v,k,[])}}e.add(n[3]+1,0,[["exit",p,t]])}return r!==void 0&&(a.end=Object.assign({},Go(t.events,r)),e.add(r,0,[["exit",a,t]]),a=void 0),a}function wg(e,t,n,o,r){const a=[],i=Go(t.events,n);r&&(r.end=Object.assign({},i),a.push(["exit",r,t])),o.end=Object.assign({},i),a.push(["exit",o,t]),e.add(n+1,0,a)}function Go(e,t){const n=e[t],o=n[0]==="enter"?"start":"end";return n[1][o]}const e4={tokenize:n4};function t4(){return{text:{91:e4}}}function n4(e,t,n){const o=this;return r;function r(c){return o.previous!==null||!o._gfmTasklistFirstContentOfListItem?n(c):(e.enter("taskListCheck"),e.enter("taskListCheckMarker"),e.consume(c),e.exit("taskListCheckMarker"),a)}function a(c){return Ee(c)?(e.enter("taskListCheckValueUnchecked"),e.consume(c),e.exit("taskListCheckValueUnchecked"),i):c===88||c===120?(e.enter("taskListCheckValueChecked"),e.consume(c),e.exit("taskListCheckValueChecked"),i):n(c)}function i(c){return c===93?(e.enter("taskListCheckMarker"),e.consume(c),e.exit("taskListCheckMarker"),e.exit("taskListCheck"),s):n(c)}function s(c){return te(c)?t(c):me(c)?e.check({tokenize:o4},t,n)(c):n(c)}}function o4(e,t,n){return _e(e,o,"whitespace");function o(r){return r===null?n(r):t(r)}}function r4(e){return gv([P5(),U5(),G5(e),X5(),t4()])}const a4={};function i4(e){const t=this,n=e||a4,o=t.data(),r=o.micromarkExtensions||(o.micromarkExtensions=[]),a=o.fromMarkdownExtensions||(o.fromMarkdownExtensions=[]),i=o.toMarkdownExtensions||(o.toMarkdownExtensions=[]);r.push(r4(n)),a.push(C5()),i.push(E5(n))}var Iy={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(iR()),o=n.default;e.default=o})(Iy);const l4=Bt(Iy);var Fy={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(py()),o=n.default;e.default=o})(Fy);const s4=Bt(Fy);var Uy={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(aR()),o=n.default;e.default=o})(Uy);const c4=Bt(Uy);var Ny={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(eR()),o=n.default;e.default=o})(Ny);const u4=Bt(Ny);var Hy={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(rR()),o=n.default;e.default=o})(Hy);const d4=Bt(Hy);var Wy={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(nR()),o=n.default;e.default=o})(Wy);const p4=Bt(Wy);var By={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(tR()),o=n.default;e.default=o})(By);const f4=Bt(By);lo.registerLanguage("tsx",l4);lo.registerLanguage("typescript",s4);lo.registerLanguage("scss",c4);lo.registerLanguage("bash",u4);lo.registerLanguage("markdown",d4);lo.registerLanguage("json",p4);lo.registerLanguage("lua",f4);function h4({source:e}){const t=e.split(`
`).map(n=>n.indexOf(" [See demo")!==-1?n.substring(0,n.indexOf(" [See")):n).join(`
`);return u.jsx("div",{className:"docs",children:u.jsx("div",{className:"docs-md",children:u.jsx(dE,{remarkPlugins:[i4],components:{code({className:n,...o}){const r=/language-(\w+)/.exec(n||"");return r?u.jsx(lo,{style:fy.oneDark,language:r[1],PreTag:"div",showLineNumbers:!1,useInlineStyles:!0,children:String(o.children).replace(/\n$/,"")}):u.jsx("code",{className:n,...o})},pre:n=>{var r;const o=(r=n.children[0])==null?void 0:r.props.className.replace(/language-/g,"");return u.jsxs("div",{className:"relative overflow-x-hidden",children:[u.jsx("span",{style:{bottom:0,right:0},children:o}),u.jsx("pre",{...n})]})}},children:t})})})}function O({component:e,markdown:t}){return u.jsxs(u.Fragment,{children:[e&&u.jsx(X1,{children:e}),t&&u.jsx(h4,{source:t})]})}const M=()=>u.jsx("div",{style:{position:"absolute",inset:0,display:"flex",width:"100%",height:"99vh",justifyContent:"center",alignItems:"center"},children:u.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",xmlnsXlink:"http://www.w3.org/1999/xlink","aria-hidden":"true",role:"img",className:"iconify iconify--logos",width:"80",height:"71.24",preserveAspectRatio:"xMidYMid meet",viewBox:"0 0 256 228",children:[u.jsx("animateTransform",{attributeName:"transform",type:"rotate",dur:".8s",values:"0 0 0;360 0 0;",repeatCount:"indefinite"}),u.jsx("path",{fill:"#f84956",d:"M210.483 73.824a171.49 171.49 0 0 0-8.24-2.597c.465-1.9.893-3.777 1.273-5.621c6.238-30.281 2.16-54.676-11.769-62.708c-13.355-7.7-35.196.329-57.254 19.526a171.23 171.23 0 0 0-6.375 5.848a155.866 155.866 0 0 0-4.241-3.917C100.759 3.829 77.587-4.822 63.673 3.233C50.33 10.957 46.379 33.89 51.995 62.588a170.974 170.974 0 0 0 1.892 8.48c-3.28.932-6.445 1.924-9.474 2.98C17.309 83.498 0 98.307 0 113.668c0 15.865 18.582 31.778 46.812 41.427a145.52 145.52 0 0 0 6.921 2.165a167.467 167.467 0 0 0-2.01 9.138c-5.354 28.2-1.173 50.591 12.134 58.266c13.744 7.926 36.812-.22 59.273-19.855a145.567 145.567 0 0 0 5.342-4.923a168.064 168.064 0 0 0 6.92 6.314c21.758 18.722 43.246 26.282 56.54 18.586c13.731-7.949 18.194-32.003 12.4-61.268a145.016 145.016 0 0 0-1.535-6.842c1.62-.48 3.21-.974 4.76-1.488c29.348-9.723 48.443-25.443 48.443-41.52c0-15.417-17.868-30.326-45.517-39.844Zm-6.365 70.984c-1.4.463-2.836.91-4.3 1.345c-3.24-10.257-7.612-21.163-12.963-32.432c5.106-11 9.31-21.767 12.459-31.957c2.619.758 5.16 1.557 7.61 2.4c23.69 8.156 38.14 20.213 38.14 29.504c0 9.896-15.606 22.743-40.946 31.14Zm-10.514 20.834c2.562 12.94 2.927 24.64 1.23 33.787c-1.524 8.219-4.59 13.698-8.382 15.893c-8.067 4.67-25.32-1.4-43.927-17.412a156.726 156.726 0 0 1-6.437-5.87c7.214-7.889 14.423-17.06 21.459-27.246c12.376-1.098 24.068-2.894 34.671-5.345a134.17 134.17 0 0 1 1.386 6.193ZM87.276 214.515c-7.882 2.783-14.16 2.863-17.955.675c-8.075-4.657-11.432-22.636-6.853-46.752a156.923 156.923 0 0 1 1.869-8.499c10.486 2.32 22.093 3.988 34.498 4.994c7.084 9.967 14.501 19.128 21.976 27.15a134.668 134.668 0 0 1-4.877 4.492c-9.933 8.682-19.886 14.842-28.658 17.94ZM50.35 144.747c-12.483-4.267-22.792-9.812-29.858-15.863c-6.35-5.437-9.555-10.836-9.555-15.216c0-9.322 13.897-21.212 37.076-29.293c2.813-.98 5.757-1.905 8.812-2.773c3.204 10.42 7.406 21.315 12.477 32.332c-5.137 11.18-9.399 22.249-12.634 32.792a134.718 134.718 0 0 1-6.318-1.979Zm12.378-84.26c-4.811-24.587-1.616-43.134 6.425-47.789c8.564-4.958 27.502 2.111 47.463 19.835a144.318 144.318 0 0 1 3.841 3.545c-7.438 7.987-14.787 17.08-21.808 26.988c-12.04 1.116-23.565 2.908-34.161 5.309a160.342 160.342 0 0 1-1.76-7.887Zm110.427 27.268a347.8 347.8 0 0 0-7.785-12.803c8.168 1.033 15.994 2.404 23.343 4.08c-2.206 7.072-4.956 14.465-8.193 22.045a381.151 381.151 0 0 0-7.365-13.322Zm-45.032-43.861c5.044 5.465 10.096 11.566 15.065 18.186a322.04 322.04 0 0 0-30.257-.006c4.974-6.559 10.069-12.652 15.192-18.18ZM82.802 87.83a323.167 323.167 0 0 0-7.227 13.238c-3.184-7.553-5.909-14.98-8.134-22.152c7.304-1.634 15.093-2.97 23.209-3.984a321.524 321.524 0 0 0-7.848 12.897Zm8.081 65.352c-8.385-.936-16.291-2.203-23.593-3.793c2.26-7.3 5.045-14.885 8.298-22.6a321.187 321.187 0 0 0 7.257 13.246c2.594 4.48 5.28 8.868 8.038 13.147Zm37.542 31.03c-5.184-5.592-10.354-11.779-15.403-18.433c4.902.192 9.899.29 14.978.29c5.218 0 10.376-.117 15.453-.343c-4.985 6.774-10.018 12.97-15.028 18.486Zm52.198-57.817c3.422 7.8 6.306 15.345 8.596 22.52c-7.422 1.694-15.436 3.058-23.88 4.071a382.417 382.417 0 0 0 7.859-13.026a347.403 347.403 0 0 0 7.425-13.565Zm-16.898 8.101a358.557 358.557 0 0 1-12.281 19.815a329.4 329.4 0 0 1-23.444.823c-7.967 0-15.716-.248-23.178-.732a310.202 310.202 0 0 1-12.513-19.846h.001a307.41 307.41 0 0 1-10.923-20.627a310.278 310.278 0 0 1 10.89-20.637l-.001.001a307.318 307.318 0 0 1 12.413-19.761c7.613-.576 15.42-.876 23.31-.876H128c7.926 0 15.743.303 23.354.883a329.357 329.357 0 0 1 12.335 19.695a358.489 358.489 0 0 1 11.036 20.54a329.472 329.472 0 0 1-11 20.722Zm22.56-122.124c8.572 4.944 11.906 24.881 6.52 51.026c-.344 1.668-.73 3.367-1.15 5.09c-10.622-2.452-22.155-4.275-34.23-5.408c-7.034-10.017-14.323-19.124-21.64-27.008a160.789 160.789 0 0 1 5.888-5.4c18.9-16.447 36.564-22.941 44.612-18.3ZM128 90.808c12.625 0 22.86 10.235 22.86 22.86s-10.235 22.86-22.86 22.86s-22.86-10.235-22.86-22.86s10.235-22.86 22.86-22.86Z"})]})}),m4=`# ErrorBoundary
...
> - _Record<string, unknown>_  
>`,I4=`# removeDuplicatedFromArrayObjects
...
> __result__: array
> - _T[]_  
>`,F4=`# removePropertiesFromArrayObjects
...
> - _T_  
>`,VM=`# useMemoizedFn
Hook to store a function that will never change while keeping its dependencies always up to date. Can be used instead of _useCallback_, without esplicity dependencies array. [See demo](https://nDriaDev.io/react-tools/#/hooks/performance/useMemoizedFn)
...
> - _T_  
>`,$M=`# useMergedRef
Hook to merge multiple refs into one. [See demo](https://nDriaDev.io/react-tools/#/hooks/performance/useMergedRef)
...
> - _RefObject<T>_  
>`,qM=`# useMouse
Hook to track mouse position also in relationship with an element. It works with pointerEvents. [See demo](https://nDriaDev.io/react-tools/#/hooks/events/useMouse)
...
>`,o9=`# useProxyState
Hook to handle component state that allows you to use an object for your state and mutating it in a way more idiomatic for JS. __*N.B.*__ not destructure state, otherwise break changes updated. [See demo](https://nDriaDev.io/react-tools/#/hooks/state/useProxyState)
...
>`,c9=`# useReducerHistoryGetter
Custom useReducer with getter state function and that tracks and allows to use previous values. [See demo](https://nDriaDev.io/react-tools/#/hooks/state/useReducerHistoryGetter)
...
>`,w9=`# useSpeechSynthesis
Hook to use _SpeechSynthesis API_. Refer to [Web Speech API](https://developer.mozilla.org/en-US/docs/Web/API/SpeechSynthesis). [See demo](https://nDriaDev.io/react-tools/#/hooks/api-dom/useSpeechSynthesis)
...
>     - _()=>void_  
>`,x9=`# useStateHistory
Custom useState that tracks and allows to use previous values. [See demo](https://nDriaDev.io/react-tools/#/hooks/state/useStateHistory)
...
>`,F9=`# useWebWorkerFn
Hook to run expensive functions using a Web Worker without blocking the UI handling execution as Promise. [See demo](https://nDriaDev.io/react-tools/#/hooks/api-dom/useWebWorkerFn)
...
>`;function U9(){return u.jsxs("div",{className:"home-container",children:[u.jsx("img",{src:Zb,alt:"react",className:"logo"}),u.jsx("h1",{className:"title",children:"React Tools"}),u.jsx("h2",{children:"A collection of hooks, components and utilities for React"}),u.jsxs("div",{className:"npm-container",children:[u.jsx("span",{className:"npm-copy",onClick:()=>navigator.clipboard.writeText("npm i @ndriadev/react-tools"),children:"copy"}),u.jsx("p",{className:"npm-command",children:u.jsx("code",{children:"npm i @ndriadev/react-tools"})})]}),u.jsx(z,{className:"get-started",onClick:()=>{var e;return(e=document.querySelector(".container"))==null?void 0:e.scrollTo(0,0)},to:"/hooks",children:"GET STARTED"}),u.jsxs("div",{className:"features-container",children:[u.jsxs("div",{className:"cell",children:[u.jsx("div",{className:"title",children:"Typescript"}),u.jsx("div",{className:"body",children:"Written in typescript for type safety."})]}),u.jsxs("div",{className:"cell",children:[u.jsx("div",{className:"title",children:"Tree Shakable"}),u.jsx("div",{className:"body",children:"Import only that you use. Indivual import cost is tiny."})]}),u.jsxs("div",{className:"cell",children:[u.jsx("div",{className:"title",children:"Demos"}),u.jsx("div",{className:"body",children:"All implementations have a demo that allow you to try them."})]})]})]})}function N9(){const[e]=F1();return e.has("route")?u.jsx(vn,{to:`/${e.get("route")}`,replace:!0}):u.jsx(U9,{})}const H9=y.lazy(()=>H(()=>import("./ErrorBoundary-996d2628.js"),[]).then(e=>({default:"default"in e?e.default:e.ErrorBoundary}))),W9=y.lazy(()=>H(()=>import("./For-46749ad7.js"),[]).then(e=>({default:"default"in e?e.default:e.For}))),Sg=y.lazy(()=>H(()=>import("./Lazy-bd6e6325.js"),[]).then(e=>({default:"default"in e?e.default:e.Lazy}))),B9=y.lazy(()=>H(()=>import("./Show-a46de01a.js"),[]).then(e=>({default:"default"in e?e.default:e.Show}))),V9=y.lazy(()=>H(()=>import("./SwitchCase-af413772.js"),[]).then(e=>({default:"default"in e?e.default:e.SwitchCase}))),$9=y.lazy(()=>H(()=>import("./UseActiveElement-c5bd779e.js"),["assets/UseActiveElement-c5bd779e.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseActiveElement}))),q9=y.lazy(()=>H(()=>import("./UseAnimation-e69b253c.js"),[]).then(e=>({default:"default"in e?e.default:e.UseAnimation}))),G9=y.lazy(()=>H(()=>import("./UseAudio-d8ca5392.js"),["assets/UseAudio-d8ca5392.js","assets/createHTMLMediaElement-b372adcd.js"]).then(e=>({default:"default"in e?e.default:e.UseAudio}))),K9=y.lazy(()=>H(()=>import("./UseBattery-3a585ae6.js"),["assets/UseBattery-3a585ae6.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseBattery}))),Q9=y.lazy(()=>H(()=>import("./UseBluetooth-044258ca.js"),["assets/UseBluetooth-044258ca.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseBluetooth}))),Y9=y.lazy(()=>H(()=>import("./UseBroadcastChannel-9d7145ec.js"),["assets/UseBroadcastChannel-9d7145ec.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseBroadcastChannel}))),X9=y.lazy(()=>H(()=>import("./UseClipboard-e82fcf43.js"),["assets/UseClipboard-e82fcf43.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseClipboard}))),J9=y.lazy(()=>H(()=>import("./UseColorScheme-b96d0fa4.js"),["assets/UseColorScheme-b96d0fa4.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseColorScheme}))),Z9=y.lazy(()=>H(()=>import("./UseDebounce-311e51ad.js"),[]).then(e=>({default:"default"in e?e.default:e.UseDebounce}))),ej=y.lazy(()=>H(()=>import("./UseDeviceMotion-e5242ca8.js"),["assets/UseDeviceMotion-e5242ca8.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseDeviceMotion}))),tj=y.lazy(()=>H(()=>import("./UseDeviceOrientation-e23ae444.js"),["assets/UseDeviceOrientation-e23ae444.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseDeviceOrientation}))),nj=y.lazy(()=>H(()=>import("./UseDialogBox-6c1238d2.js"),[]).then(e=>({default:"default"in e?e.default:e.UseDialogBox}))),oj=y.lazy(()=>H(()=>import("./UseDisplayMedia-a9fa31aa.js"),["assets/UseDisplayMedia-a9fa31aa.js","assets/useMediaDevices-4e3d8e92.js","assets/useEffectOnce-fafad077.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseDisplayMedia}))),rj=y.lazy(()=>H(()=>import("./UseDocumentPIP-c71f9c99.js"),["assets/UseDocumentPIP-c71f9c99.js","assets/useRerender-de75d8dd.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseDocumentPIP}))),aj=y.lazy(()=>H(()=>import("./UseEyeDropper-2eed1949.js"),[]).then(e=>({default:"default"in e?e.default:e.UseEyeDropper}))),ij=y.lazy(()=>H(()=>import("./UseFPS-cdb24073.js"),["assets/UseFPS-cdb24073.js","assets/useRaf-4af3da0b.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseFPS}))),lj=y.lazy(()=>H(()=>import("./UseFetch-1afc42e8.js"),[]).then(e=>({default:"default"in e?e.default:e.UseFetch}))),sj=y.lazy(()=>H(()=>import("./UseFullscreen-9b53fabe.js"),["assets/UseFullscreen-9b53fabe.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseFullscreen}))),cj=y.lazy(()=>H(()=>import("./UseGeolocation-418fa758.js"),["assets/UseGeolocation-418fa758.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseGeolocation}))),uj=y.lazy(()=>H(()=>import("./UseIdleCallback-ae8e9820.js"),[]).then(e=>({default:"default"in e?e.default:e.UseIdleCallback}))),dj=y.lazy(()=>H(()=>import("./UseInterval-700a451d.js"),["assets/UseInterval-700a451d.js","assets/useInterval-b84ea863.js"]).then(e=>({default:"default"in e?e.default:e.UseInterval}))),pj=y.lazy(()=>H(()=>import("./UseLock-dbae0bb4.js"),[]).then(e=>({default:"default"in e?e.default:e.UseLock}))),fj=y.lazy(()=>H(()=>import("./UseMediaDevices-ae26a7a4.js"),["assets/UseMediaDevices-ae26a7a4.js","assets/useMediaDevices-4e3d8e92.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseMediaDevices}))),hj=y.lazy(()=>H(()=>import("./UseMediaQuery-a593beea.js"),["assets/UseMediaQuery-a593beea.js","assets/useMediaQuery-e2f8610c.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseMediaQuery}))),mj=y.lazy(()=>H(()=>import("./UsePIP-e7865101.js"),["assets/UsePIP-e7865101.js","assets/mov_bbb-3a4cadaf.js"]).then(e=>({default:"default"in e?e.default:e.UsePIP}))),gj=y.lazy(()=>H(()=>import("./UsePermission-dc744e21.js"),["assets/UsePermission-dc744e21.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UsePermission}))),_j=y.lazy(()=>H(()=>import("./UsePopover-b4c1aef8.js"),["assets/UsePopover-b4c1aef8.js","assets/useLazyRef-ebe5109b.js","assets/useMergedRef-ac76bea5.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UsePopover}))),bj=y.lazy(()=>H(()=>import("./UsePromiseSuspensible-4293180d.js"),["assets/UsePromiseSuspensible-4293180d.js","assets/useEffectOnce-fafad077.js","assets/isDeepEqual-91d55382.js"]).then(e=>({default:"default"in e?e.default:e.UsePromiseSuspensible}))),vj=y.lazy(()=>H(()=>import("./UsePublishSubscribe-65f58811.js"),["assets/UsePublishSubscribe-65f58811.js","assets/PublishSubscribePattern-3c538608.js"]).then(e=>({default:"default"in e?e.default:e.UsePublishSubscribe}))),yj=y.lazy(()=>H(()=>import("./UseRaf-b641d2e4.js"),["assets/UseRaf-b641d2e4.js","assets/useRaf-4af3da0b.js","assets/useResizeObserver-df213ed2.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseRaf}))),kj=y.lazy(()=>H(()=>import("./UseReducedMotion-06802960.js"),["assets/UseReducedMotion-06802960.js","assets/useReducedMotion-80e55ad4.js","assets/useMediaQuery-e2f8610c.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseReducedMotion}))),wj=y.lazy(()=>H(()=>import("./UseRemotePlayback-a867bc28.js"),["assets/UseRemotePlayback-a867bc28.js","assets/mov_bbb-3a4cadaf.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseRemotePlayback}))),Sj=y.lazy(()=>H(()=>import("./UseScreenWakeLock-99f1c398.js"),["assets/UseScreenWakeLock-99f1c398.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseScreenWakeLock}))),xj=y.lazy(()=>H(()=>import("./UseScript-da732add.js"),["assets/UseScript-da732add.js","assets/useScript-2d9a074e.js","assets/useEffectOnce-fafad077.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseScript}))),Cj=y.lazy(()=>H(()=>import("./UseShare-3ec70f97.js"),[]).then(e=>({default:"default"in e?e.default:e.UseShare}))),Ej=y.lazy(()=>H(()=>import("./UseSpeechRecognition-7f610e35.js"),["assets/UseSpeechRecognition-7f610e35.js","assets/usePerformAction-bf3cc143.js","assets/useSyncExternalStore-4b83f1b0.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseSpeechRecognition}))),Tj=y.lazy(()=>H(()=>import("./UseSpeechSynthesis-1cb681df.js"),["assets/UseSpeechSynthesis-1cb681df.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseSpeechSynthesis}))),Aj=y.lazy(()=>H(()=>import("./UseTextSelection-e780880b.js"),["assets/UseTextSelection-e780880b.js","assets/useSyncExternalStore-4b83f1b0.js","assets/isDeepEqual-91d55382.js"]).then(e=>({default:"default"in e?e.default:e.UseTextSelection}))),Pj=y.lazy(()=>H(()=>import("./UseThrottle-ca60e45e.js"),[]).then(e=>({default:"default"in e?e.default:e.UseThrottle}))),Rj=y.lazy(()=>H(()=>import("./UseTimeout-76b0f2f3.js"),[]).then(e=>({default:"default"in e?e.default:e.UseTimeout}))),Dj=y.lazy(()=>H(()=>import("./UseTitle-b7315efd.js"),[]).then(e=>({default:"default"in e?e.default:e.UseTitle}))),Mj=y.lazy(()=>H(()=>import("./UseVibrate-559a33e8.js"),[]).then(e=>({default:"default"in e?e.default:e.UseVibrate}))),jj=y.lazy(()=>H(()=>import("./UseVideo-0754d76e.js"),["assets/UseVideo-0754d76e.js","assets/mov_bbb-3a4cadaf.js","assets/createHTMLMediaElement-b372adcd.js"]).then(e=>({default:"default"in e?e.default:e.UseVideo}))),zj=y.lazy(()=>H(()=>import("./UseWebWorker-07536033.js"),["assets/UseWebWorker-07536033.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseWebWorker}))),Oj=y.lazy(()=>H(()=>import("./UseWebWorkerFn-e6b8925b.js"),["assets/UseWebWorkerFn-e6b8925b.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseWebWorkerFn}))),Lj=y.lazy(()=>H(()=>import("./UseBeforeUnload-4fbc41c8.js"),["assets/UseBeforeUnload-4fbc41c8.js","assets/useEventListener-73013607.js","assets/useMemoizedFn-cf8f4d3e.js"]).then(e=>({default:"default"in e?e.default:e.UseBeforeUnload}))),Ij=y.lazy(()=>H(()=>import("./UseClickOutside-d9cdd2d1.js"),["assets/UseClickOutside-d9cdd2d1.js","assets/useEventListener-73013607.js","assets/useMemoizedFn-cf8f4d3e.js"]).then(e=>({default:"default"in e?e.default:e.UseClickOutside}))),Fj=y.lazy(()=>H(()=>import("./UseContextMenu-b348e199.js"),["assets/UseContextMenu-b348e199.js","assets/useEventListener-73013607.js","assets/useMemoizedFn-cf8f4d3e.js"]).then(e=>({default:"default"in e?e.default:e.UseContextMenu}))),Uj=y.lazy(()=>H(()=>import("./UseDocumentVisibility-eb710e1a.js"),["assets/UseDocumentVisibility-eb710e1a.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseDocumentVisibility}))),Nj=y.lazy(()=>H(()=>import("./UseDoubleClick-36a259ec.js"),[]).then(e=>({default:"default"in e?e.default:e.UseDoubleClick}))),Hj=y.lazy(()=>H(()=>import("./UseEventDispatcher-fddcfb65.js"),["assets/UseEventDispatcher-fddcfb65.js","assets/useMemoizedFn-cf8f4d3e.js","assets/useEventListener-73013607.js"]).then(e=>({default:"default"in e?e.default:e.UseEventDispatcher}))),Wj=y.lazy(()=>H(()=>import("./UseEventListener-7844534a.js"),["assets/UseEventListener-7844534a.js","assets/useEventListener-73013607.js","assets/useMemoizedFn-cf8f4d3e.js"]).then(e=>({default:"default"in e?e.default:e.UseEventListener}))),Bj=y.lazy(()=>H(()=>import("./UseEvents-add2b2ed.js"),["assets/UseEvents-add2b2ed.js","assets/useEvents-b803aa25.js"]).then(e=>({default:"default"in e?e.default:e.UseEvents}))),Vj=y.lazy(()=>H(()=>import("./UseHotKeys-2e16d745.js"),["assets/UseHotKeys-2e16d745.js","assets/useEventListener-73013607.js","assets/useMemoizedFn-cf8f4d3e.js"]).then(e=>({default:"default"in e?e.default:e.UseHotKeys}))),$j=y.lazy(()=>H(()=>import("./UseHover-81f46820.js"),["assets/UseHover-81f46820.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseHover}))),qj=y.lazy(()=>H(()=>import("./UseInfiniteScroll-ac345c7c.js"),["assets/UseInfiniteScroll-ac345c7c.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseInfiniteScroll}))),Gj=y.lazy(()=>H(()=>import("./UseIntersectionObserver-9b2501d1.js"),["assets/UseIntersectionObserver-9b2501d1.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseIntersectionObserver}))),Kj=y.lazy(()=>H(()=>import("./UseIsOnline-9e7cef3d.js"),["assets/UseIsOnline-9e7cef3d.js","assets/useNetwork-74757b34.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseIsOnline}))),Qj=y.lazy(()=>H(()=>import("./UseLongPress-e50e9f1d.js"),[]).then(e=>({default:"default"in e?e.default:e.UseLongPress}))),Yj=y.lazy(()=>H(()=>import("./UseMeasure-fbdfc790.js"),["assets/UseMeasure-fbdfc790.js","assets/useResizeObserver-df213ed2.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseMeasure}))),Xj=y.lazy(()=>H(()=>import("./UseMouse-159b939e.js"),["assets/UseMouse-159b939e.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseMouse}))),Jj=y.lazy(()=>H(()=>import("./UseMutationObserver-fce8281b.js"),["assets/UseMutationObserver-fce8281b.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseMutationObserver}))),Zj=y.lazy(()=>H(()=>import("./UseNetwork-6fd3f648.js"),["assets/UseNetwork-6fd3f648.js","assets/useNetwork-74757b34.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseNetwork}))),ez=y.lazy(()=>H(()=>import("./UsePerformAction-8d8f34d2.js"),["assets/UsePerformAction-8d8f34d2.js","assets/usePerformAction-bf3cc143.js","assets/useScript-2d9a074e.js","assets/useEffectOnce-fafad077.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UsePerformAction}))),tz=y.lazy(()=>H(()=>import("./UsePinchZoom-f931f8bd.js"),["assets/UsePinchZoom-f931f8bd.js","assets/useEventListener-73013607.js","assets/useMemoizedFn-cf8f4d3e.js"]).then(e=>({default:"default"in e?e.default:e.UsePinchZoom}))),nz=y.lazy(()=>H(()=>import("./UsePointerLock-74acd466.js"),[]).then(e=>({default:"default"in e?e.default:e.UsePointerLock}))),oz=y.lazy(()=>H(()=>import("./UseResizeObserver-844b5c84.js"),["assets/UseResizeObserver-844b5c84.js","assets/useResizeObserver-df213ed2.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseResizeObserver}))),rz=y.lazy(()=>H(()=>import("./UseResponsive-0e37a33c.js"),["assets/UseResponsive-0e37a33c.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseResponsive}))),az=y.lazy(()=>H(()=>import("./UseScreen-c4dbfe29.js"),["assets/UseScreen-c4dbfe29.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseScreen}))),iz=y.lazy(()=>H(()=>import("./UseScrollIntoView-d4453457.js"),["assets/UseScrollIntoView-d4453457.js","assets/useEventListener-73013607.js","assets/useMemoizedFn-cf8f4d3e.js","assets/useReducedMotion-80e55ad4.js","assets/useMediaQuery-e2f8610c.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseScrollIntoView}))),lz=y.lazy(()=>H(()=>import("./UseSwipe-fb3e122d.js"),["assets/UseSwipe-fb3e122d.js","assets/useEventListener-73013607.js","assets/useMemoizedFn-cf8f4d3e.js"]).then(e=>({default:"default"in e?e.default:e.UseSwipe}))),sz=y.lazy(()=>H(()=>import("./UseVisible-834cc929.js"),["assets/UseVisible-834cc929.js","assets/useEffectOnce-fafad077.js","assets/useSyncExternalStore-4b83f1b0.js"]).then(e=>({default:"default"in e?e.default:e.UseVisible}))),cz=y.lazy(()=>H(()=>import("./UseEffectCompare-e9662a93.js"),[]).then(e=>({default:"default"in e?e.default:e.UseEffectCompare}))),uz=y.lazy(()=>H(()=>import("./UseEffectDeepCompare-9633ed9c.js"),["assets/UseEffectDeepCompare-9633ed9c.js","assets/isDeepEqual-91d55382.js"]).then(e=>({default:"default"in e?e.default:e.UseEffectDeepCompare}))),dz=y.lazy(()=>H(()=>import("./UseEffectOnce-91d74152.js"),["assets/UseEffectOnce-91d74152.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseEffectOnce}))),pz=y.lazy(()=>H(()=>import("./UseIsMounted-eb9bc3a4.js"),["assets/UseIsMounted-eb9bc3a4.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseIsMounted}))),fz=y.lazy(()=>H(()=>import("./UseLogger-0340fb82.js"),[]).then(e=>({default:"default"in e?e.default:e.UseLogger}))),hz=y.lazy(()=>H(()=>import("./UseRerender-eec312c5.js"),["assets/UseRerender-eec312c5.js","assets/useRerender-de75d8dd.js"]).then(e=>({default:"default"in e?e.default:e.UseRerender}))),mz=y.lazy(()=>H(()=>import("./UseCallbackCompare-84100a34.js"),[]).then(e=>({default:"default"in e?e.default:e.UseCallbackCompare}))),gz=y.lazy(()=>H(()=>import("./UseCallbackDeepCompare-9a493867.js"),["assets/UseCallbackDeepCompare-9a493867.js","assets/isDeepEqual-91d55382.js"]).then(e=>({default:"default"in e?e.default:e.UseCallbackDeepCompare}))),_z=y.lazy(()=>H(()=>import("./UseLazyRef-f90ce046.js"),["assets/UseLazyRef-f90ce046.js","assets/useRerender-de75d8dd.js","assets/useInterval-b84ea863.js","assets/useLazyRef-ebe5109b.js"]).then(e=>({default:"default"in e?e.default:e.UseLazyRef}))),bz=y.lazy(()=>H(()=>import("./UseMemoCompare-1cfc70ad.js"),[]).then(e=>({default:"default"in e?e.default:e.UseMemoCompare}))),vz=y.lazy(()=>H(()=>import("./UseMemoDeepCompare-fae00e99.js"),["assets/UseMemoDeepCompare-fae00e99.js","assets/isDeepEqual-91d55382.js"]).then(e=>({default:"default"in e?e.default:e.UseMemoDeepCompare}))),yz=y.lazy(()=>H(()=>import("./UseMemoizedFn-0d6c9def.js"),["assets/UseMemoizedFn-0d6c9def.js","assets/useMemoizedFn-cf8f4d3e.js"]).then(e=>({default:"default"in e?e.default:e.UseMemoizedFn}))),kz=y.lazy(()=>H(()=>import("./UseMergedRef-d235fb20.js"),["assets/UseMergedRef-d235fb20.js","assets/useResizeObserver-df213ed2.js","assets/useEffectOnce-fafad077.js","assets/useMergedRef-ac76bea5.js"]).then(e=>({default:"default"in e?e.default:e.UseMergedRef}))),wz=y.lazy(()=>H(()=>import("./CreatePubSubStore-233c9d18.js"),["assets/CreatePubSubStore-233c9d18.js","assets/PublishSubscribePattern-3c538608.js","assets/useLazyRef-ebe5109b.js","assets/useSyncExternalStore-4b83f1b0.js","assets/isDeepEqual-91d55382.js"]).then(e=>({default:"default"in e?e.default:e.CreatePubSubStore}))),Sz=y.lazy(()=>H(()=>import("./UseArray-1ad6269e.js"),[]).then(e=>({default:"default"in e?e.default:e.UseArray}))),xz=y.lazy(()=>H(()=>import("./UseDerivedState-dc191a5a.js"),[]).then(e=>({default:"default"in e?e.default:e.UseDerivedState}))),Cz=y.lazy(()=>H(()=>import("./UseLocalStorageState-7b3bf917.js"),["assets/UseLocalStorageState-7b3bf917.js","assets/useEvents-b803aa25.js","assets/useMemoizedFn-cf8f4d3e.js","assets/useEffectOnce-fafad077.js"]).then(e=>({default:"default"in e?e.default:e.UseLocalStorageState}))),Ez=y.lazy(()=>H(()=>import("./UseMap-4c12ee22.js"),[]).then(e=>({default:"default"in e?e.default:e.UseMap}))),Tz=y.lazy(()=>H(()=>import("./UsePrevious-7d33453d.js"),[]).then(e=>({default:"default"in e?e.default:e.UsePrevious}))),Az=y.lazy(()=>H(()=>import("./UseProxyState-dbac3273.js"),[]).then(e=>({default:"default"in e?e.default:e.UseProxyState}))),Pz=y.lazy(()=>H(()=>import("./UseSessionStorageState-bef55731.js"),["assets/UseSessionStorageState-bef55731.js","assets/useEvents-b803aa25.js","assets/useMemoizedFn-cf8f4d3e.js"]).then(e=>({default:"default"in e?e.default:e.UseSessionStorageState}))),Rz=y.lazy(()=>H(()=>import("./UseSet-8cce7314.js"),[]).then(e=>({default:"default"in e?e.default:e.UseSet}))),Dz=y.lazy(()=>H(()=>import("./UseStateGetReset-ccce9c42.js"),["assets/UseStateGetReset-ccce9c42.js","assets/useMemoizedFn-cf8f4d3e.js"]).then(e=>({default:"default"in e?e.default:e.UseStateGetReset}))),Mz=y.lazy(()=>H(()=>import("./UseStateHistory-60e2922b.js"),[]).then(e=>({default:"default"in e?e.default:e.UseStateHistory}))),jz=y.lazy(()=>H(()=>import("./UseStateValidator-a3a53b4c.js"),["assets/UseStateValidator-a3a53b4c.js","assets/useMemoizedFn-cf8f4d3e.js"]).then(e=>({default:"default"in e?e.default:e.UseStateValidator})));function zz(){const e=M1([{path:"/",element:u.jsx(Y1,{}),children:[{index:!0,element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(N9,{})})},{path:"hooks",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/hooks/state/createPubSubStore",replace:!0})},{path:"state",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/createPubSubStore",replace:!0})},{path:"createPubSubStore",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:w4,component:u.jsx(wz,{})})})},{path:"useArray",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:H4,component:u.jsx(Sz,{})})})},{path:"useDerivedState",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:tM,component:u.jsx(xz,{})})})},{path:"useLocalStorageState",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:zM,component:u.jsx(Cz,{})})})},{path:"useMap",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:FM,component:u.jsx(Ez,{})})})},{path:"usePrevious",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:t9,component:u.jsx(Tz,{})})})},{path:"useProxyState",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:o9,component:u.jsx(Az,{})})})},{path:"useReducerGetReset",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:l9})})},{path:"useReducerHistory",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:s9})})},{path:"useReducerHistoryGetter",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:c9})})},{path:"useSessionStorageState",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:b9,component:u.jsx(Pz,{})})})},{path:"useSet",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:v9,component:u.jsx(Rz,{})})})},{path:"useStateGetReset",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:S9,component:u.jsx(Dz,{})})})},{path:"useStateHistory",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:x9,component:u.jsx(Mz,{})})})},{path:"useStateHistoryGetter",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:C9})})},{path:"useStateValidator",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:E9,component:u.jsx(jz,{})})})},{path:"useSyncExternalStore",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:A9})})}]},{path:"lifecycle",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/useDeferredValue",replace:!0})},{path:"useDeferredValue",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:eM})})},{path:"useEffectCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:cM,component:u.jsx(cz,{})})})},{path:"useEffectDeepCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:uM,component:u.jsx(uz,{})})})},{path:"useEffectOnce",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:dM,component:u.jsx(dz,{})})})},{path:"useIsMounted",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:AM,component:u.jsx(pz,{})})})},{path:"useLayoutEffectCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:RM})})},{path:"useLayoutEffectDeepCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:DM})})},{path:"useLayoutEffectOnce",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:MM})})},{path:"useLogger",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:LM,component:u.jsx(fz,{})})})},{path:"useRerender",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:d9,component:u.jsx(hz,{})})})}]},{path:"performance",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/useCallbackCompare",replace:!0})},{path:"useCallbackCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:G4,component:u.jsx(mz,{})})})},{path:"useCallbackDeepCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:K4,component:u.jsx(gz,{})})})},{path:"useId",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:SM})})},{path:"useLazyRef",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:jM,component:u.jsx(_z,{})})})},{path:"useMemoCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:WM,component:u.jsx(bz,{})})})},{path:"useMemoDeepCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:BM,component:u.jsx(vz,{})})})},{path:"useMemoizedFn",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:VM,component:u.jsx(yz,{})})})},{path:"useMergedRef",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:$M,component:u.jsx(kz,{})})})}]},{path:"events",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/useBeforeUnload",replace:!0})},{path:"useBeforeUnload",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:V4,component:u.jsx(Lj,{})})})},{path:"useClickOutside",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:Q4,component:u.jsx(Ij,{})})})},{path:"useContextMenu",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:J4,component:u.jsx(Fj,{})})})},{path:"useDocumentVisibility",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:lM,component:u.jsx(Uj,{})})})},{path:"useDoubleClick",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:sM,component:u.jsx(Nj,{})})})},{path:"useEventDispatcher",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:pM,component:u.jsx(Hj,{})})})},{path:"useEventListener",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:fM,component:u.jsx(Wj,{})})})},{path:"useEvents",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:mM,component:u.jsx(Bj,{})})})},{path:"useHotKeys",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:kM,component:u.jsx(Vj,{})})})},{path:"useHover",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:wM,component:u.jsx($j,{})})})},{path:"useInfiniteScroll",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:CM,component:u.jsx(qj,{})})})},{path:"useIntersectionObserver",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:EM,component:u.jsx(Gj,{})})})},{path:"useIsOnline",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:PM,component:u.jsx(Kj,{})})})},{path:"useLongPress",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:IM,component:u.jsx(Qj,{})})})},{path:"useMeasure",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:UM,component:u.jsx(Yj,{})})})},{path:"useMouse",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:qM,component:u.jsx(Xj,{})})})},{path:"useMutationObserver",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:GM,component:u.jsx(Jj,{})})})},{path:"useNetwork",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:KM,component:u.jsx(Zj,{})})})},{path:"usePerformAction",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:YM,component:u.jsx(ez,{})})})},{path:"usePinchZoom",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:JM,component:u.jsx(tz,{})})})},{path:"usePointerLock",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:ZM,component:u.jsx(nz,{})})})},{path:"useResizeObserver",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:p9,component:u.jsx(oz,{})})})},{path:"useResponsive",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:f9,component:u.jsx(rz,{})})})},{path:"useScreen",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:h9,component:u.jsx(az,{})})})},{path:"useScrollIntoView",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:_9,component:u.jsx(iz,{})})})},{path:"useSwipe",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:T9,component:u.jsx(lz,{})})})},{path:"useVisible",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:O9,component:u.jsx(sz,{})})})}]},{path:"api-dom",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/useActiveElement",replace:!0})},{path:"useActiveElement",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:U4,component:u.jsx($9,{})})})},{path:"useAnimation",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:N4,component:u.jsx(q9,{})})})},{path:"useAudio",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:W4,component:u.jsx(G9,{})})})},{path:"useBattery",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:B4,component:u.jsx(K9,{})})})},{path:"useBluetooth",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:$4,component:u.jsx(Q9,{})})})},{path:"useBroadcastChannel",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:q4,component:u.jsx(Y9,{})})})},{path:"useClipboard",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:Y4,component:u.jsx(X9,{})})})},{path:"useColorScheme",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:X4,component:u.jsx(J9,{})})})},{path:"useDebounce",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:Z4,component:u.jsx(Z9,{})})})},{path:"useDeviceMotion",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:nM,component:u.jsx(ej,{})})})},{path:"useDeviceOrientation",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:oM,component:u.jsx(tj,{})})})},{path:"useDialogBox",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:rM,component:u.jsx(nj,{})})})},{path:"useDisplayMedia",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:aM,component:u.jsx(oj,{})})})},{path:"useDocumentPIP",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:iM,component:u.jsx(rj,{})})})},{path:"useEventSource",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:hM})})},{path:"useEyeDropper",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:gM,component:u.jsx(aj,{})})})},{path:"useFetch",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:bM,component:u.jsx(lj,{})})})},{path:"useFPS",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:_M,component:u.jsx(ij,{})})})},{path:"useFullscreen",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:vM,component:u.jsx(sj,{})})})},{path:"useGeolocation",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:yM,component:u.jsx(cj,{})})})},{path:"useIdleCallback",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:xM,component:u.jsx(uj,{})})})},{path:"useInterval",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:TM,component:u.jsx(dj,{})})})},{path:"useLock",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:OM,component:u.jsx(pj,{})})})},{path:"useMediaDevices",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:NM,component:u.jsx(fj,{})})})},{path:"useMediaQuery",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:HM,component:u.jsx(hj,{})})})},{path:"usePermission",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:XM,component:u.jsx(gj,{})})})},{path:"usePIP",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:QM,component:u.jsx(mj,{})})})},{path:"usePopover",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:e9,component:u.jsx(_j,{})})})},{path:"usePromiseSuspensible",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:n9,component:u.jsx(bj,{})})})},{path:"usePublishSubscribe",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:r9,component:u.jsx(vj,{})})})},{path:"useRaf",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:a9,component:u.jsx(yj,{})})})},{path:"useReducedMotion",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:i9,component:u.jsx(kj,{})})})},{path:"useRemotePlayback",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:u9,component:u.jsx(wj,{})})})},{path:"useScreenWakeLock",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:m9,component:u.jsx(Sj,{})})})},{path:"useScript",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:g9,component:u.jsx(xj,{})})})},{path:"useShare",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:y9,component:u.jsx(Cj,{})})})},{path:"useSpeechRecognition",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:k9,component:u.jsx(Ej,{})})})},{path:"useSpeechSynthesis",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:w9,component:u.jsx(Tj,{})})})},{path:"useTextSelection",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:P9,component:u.jsx(Aj,{})})})},{path:"useThrottle",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:R9,component:u.jsx(Pj,{})})})},{path:"useTimeout",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:D9,component:u.jsx(Rj,{})})})},{path:"useTitle",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:M9,component:u.jsx(Dj,{})})})},{path:"useVibrate",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:j9,component:u.jsx(Mj,{})})})},{path:"useVideo",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:z9,component:u.jsx(jj,{})})})},{path:"useWebSocket",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:L9})})},{path:"useWebWorker",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:I9,component:u.jsx(zj,{})})})},{path:"useWebWorkerFn",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:F9,component:u.jsx(Oj,{})})})}]}]},{path:"components",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/components/ErrorBoundary",replace:!0})},{path:"ErrorBoundary",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:m4,component:u.jsx(H9,{})})})},{path:"For",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:g4,component:u.jsx(W9,{})})})},{path:"Lazy",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:_4,component:u.jsx(Sg,{})})})},{path:"Show",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:b4,component:u.jsx(B9,{})})})},{path:"SwitchCase",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:v4,component:u.jsx(V9,{})})})}]},{path:"utils",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/utils/alphanumericCompare",replace:!0})},{path:"alphanumericCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:y4})})},{path:"changeStringCase",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:k4})})},{path:"defaultSerializer",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:S4})})},{path:"detectBrowser",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:x4})})},{path:"getBase64",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:C4})})},{path:"getKeyObjectFromValue",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:E4})})},{path:"getObjectFromDottedString",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:T4})})},{path:"hotKeyHandler",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:A4})})},{path:"isAsync",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:P4})})},{path:"isClient",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:R4})})},{path:"isDeepEqual",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:D4})})},{path:"isMouseEvent",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:M4})})},{path:"isShallowEqual",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:j4})})},{path:"isTouchEvent",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:z4})})},{path:"lazy",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:O4,component:u.jsx(Sg,{})})})},{path:"mergeObjects",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:L4})})},{path:"removeDuplicatedFromArrayObjects",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:I4})})},{path:"removePropertiesFromArrayObjects",element:u.jsx(y.Suspense,{fallback:u.jsx(M,{}),children:u.jsx(O,{markdown:F4})})}]}]}]);return u.jsx(S1,{router:e})}function Oz(){return u.jsx(zz,{})}Wc.createRoot(document.getElementById("root")).render(u.jsx(y.StrictMode,{children:u.jsx(Oz,{})}));export{H as _,Ib as a,u as j,y as r};
