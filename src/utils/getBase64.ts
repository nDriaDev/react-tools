...
import { GetBase64Props, ToDataURLOptions, UseBase64ObjectOptions } from "../models";
 ...
 * @see [📖 Documentation](https://react-tools.ndria.dev/utils/getBase64)
 * @template T - The type of the value to serialize.
 * @param {GetBase64Props<T>["target"]} target - {@link GetBase64Props}
 * @param {GetBase64Props<T>["options"]} [options] - {@link GetBase64Props}
...
function getBase64<T>(target: GetBase64Props<T>["target"], options?: GetBase64Props<T>["options"]): Promise<string> {
