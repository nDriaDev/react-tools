 ...
 * @see [📖 Documentation](https://react-tools.ndria.dev/hooks/api-dom/useScript)
 * @param {UseScriptProps["attributes"]} attributes - {@link UseScriptProps}
 * @param {UseScriptProps["options"]} options - {@link UseScriptProps}
 * @returns {ReturnType<UseScript>} result {@link UseScript}
 */
