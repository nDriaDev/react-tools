...
/**
 * **`usePermission`**: Hook to query the status of API permissions attributed to the current context.
 * @see [PermissionAPI](https://developer.mozilla.org/en-US/docs/Web/API/Permissions_API).
 * @see [📖 Documentation](https://react-tools.ndria.dev/hooks/api-dom/usePermission)
 * @param {TPermissionName} param - {@link TPermissionName}
 * @returns {UsePermissionResult} result {@link UsePermissionResult}
 */
