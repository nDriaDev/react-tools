...
import { UseMouseOpts, UseMouseResult } from "../../models";

const listeners = new Set<() => void>();

/**
 * **`useMouse`**: Hook to track mouse position also in relationship with an element. It works with pointerEvents.
 * @see [📖 Documentation](https://react-tools.ndria.dev/hooks/events/useMouse)
 * @param {UseMouseOpts} [opts] - {@link UseMouseOpts}
 * @returns {UseMouseResult} result {@link UseMouseResult}
 */
...
function useMouse(opts: UseMouseOpts = { type: "client" }): UseMouseResult {
