...
/**
 * Props accepted by [useSpeechSynthesis](https://react-tools.ndria.dev/hooks/api-dom/useSpeechSynthesis).
 *
 */
...
/**
 * Declaration of [useSpeechSynthesis](https://react-tools.ndria.dev/hooks/api-dom/useSpeechSynthesis).
 */
