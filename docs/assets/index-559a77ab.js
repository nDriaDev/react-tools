...
`,...a.current()});return/^[\t ]/.test(l)&&(l="&#x"+l.charCodeAt(0).toString(16).toUpperCase()+";"+l.slice(1)),l=l?i+" "+l:i,n.options.closeAtx&&(l+=" "+i),c(),s(),l}by.peek=K5;function by(e){return e.value||""}function K5(){return"<"}vy.peek=Q5;function vy(e,t,n,o){const r=Dp(n),a=r==='"'?"Quote":"Apostrophe",i=n.enter("image");let s=n.enter("label");const c=n.createTracker(o);let l=c.move("![");return l+=c.move(n.safe(e.alt,{before:l,after:"]",...c.current()})),l+=c.move("]("),s(),!e.url&&e.title||/[\0- \u007F]/.test(e.url)?(s=n.enter("destinationLiteral"),l+=c.move("<"),l+=c.move(n.safe(e.url,{before:l,after:">",...c.current()})),l+=c.move(">")):(s=n.enter("destinationRaw"),l+=c.move(n.safe(e.url,{before:l,after:e.title?" ":")",...c.current()}))),s(),e.title&&(s=n.enter(`title${a}`),l+=c.move(" "+r),l+=c.move(n.safe(e.title,{before:l,after:r,...c.current()})),l+=c.move(r),s()),l+=c.move(")"),i(),l}function Q5(){return"!"}yy.peek=Y5;function yy(e,t,n,o){const r=e.referenceType,a=n.enter("imageReference");let i=n.enter("label");const s=n.createTracker(o);let c=s.move("![");const l=n.safe(e.alt,{before:c,after:"]",...s.current()});c+=s.move(l+"]["),i();const d=n.stack;n.stack=[],i=n.enter("reference");const p=n.safe(n.associationId(e),{before:c,after:"]",...s.current()});return i(),n.stack=d,a(),r==="full"||!l||l!==p?c+=s.move(p+"]"):r==="shortcut"?c=c.slice(0,-1):c+=s.move("]"),c}function Y5(){return"!"}ky.peek=X5;function ky(e,t,n){let o=e.value||"",r="`",a=-1;for(;new RegExp("(^|[^`])"+r+"([^`]|$)").test(o);)r+="`";for(/[^ \r\n]/.test(o)&&(/^[ \r\n]/.test(o)&&/[ \r\n]$/.test(o)||/^`|`$/.test(o))&&(o=" "+o+" ");++a<n.unsafe.length;){const i=n.unsafe[a],s=n.compilePattern(i);let c;if(i.atBreak)for(;c=s.exec(o);){let l=c.index;o.charCodeAt(l)===10&&o.charCodeAt(l-1)===13&&l--,o=o.slice(0,l)+" "+o.slice(c.index+1)}}return r+o+r}function X5(){return"`"}function wy(e,t){const n=ip(e);return!!(!t.options.resourceLink&&e.url&&!e.title&&e.children&&e.children.length===1&&e.children[0].type==="text"&&(n===e.url||"mailto:"+n===e.url)&&/^[a-z][a-z+.-]+:/i.test(e.url)&&!/[\0- <>\u007F]/.test(e.url))}Sy.peek=J5;function Sy(e,t,n,o){const r=Dp(n),a=r==='"'?"Quote":"Apostrophe",i=n.createTracker(o);let s,c;if(wy(e,n)){const d=n.stack;n.stack=[],s=n.enter("autolink");let p=i.move("<");return p+=i.move(n.containerPhrasing(e,{before:p,after:">",...i.current()})),p+=i.move(">"),s(),n.stack=d,p}s=n.enter("link"),c=n.enter("label");let l=i.move("[");return l+=i.move(n.containerPhrasing(e,{before:l,after:"](",...i.current()})),l+=i.move("]("),c(),!e.url&&e.title||/[\0- \u007F]/.test(e.url)?(c=n.enter("destinationLiteral"),l+=i.move("<"),l+=i.move(n.safe(e.url,{before:l,after:">",...i.current()})),l+=i.move(">")):(c=n.enter("destinationRaw"),l+=i.move(n.safe(e.url,{before:l,after:e.title?" ":")",...i.current()}))),c(),e.title&&(c=n.enter(`title${a}`),l+=i.move(" "+r),l+=i.move(n.safe(e.title,{before:l,after:r,...i.current()})),l+=i.move(r),c()),l+=i.move(")"),s(),l}function J5(e,t,n){return wy(e,n)?"<":"["}xy.peek=Z5;function xy(e,t,n,o){const r=e.referenceType,a=n.enter("linkReference");let i=n.enter("label");const s=n.createTracker(o);let c=s.move("[");const l=n.containerPhrasing(e,{before:c,after:"]",...s.current()});c+=s.move(l+"]["),i();const d=n.stack;n.stack=[],i=n.enter("reference");const p=n.safe(n.associationId(e),{before:c,after:"]",...s.current()});return i(),n.stack=d,a(),r==="full"||!l||l!==p?c+=s.move(p+"]"):r==="shortcut"?c=c.slice(0,-1):c+=s.move("]"),c}function Z5(){return"["}function jp(e){const t=e.options.bullet||"*";if(t!=="*"&&t!=="+"&&t!=="-")throw new Error("Cannot serialize items with `"+t+"` for `options.bullet`, expected `*`, `+`, or `-`");return t}function e4(e){const t=jp(e),n=e.options.bulletOther;if(!n)return t==="*"?"-":"*";if(n!=="*"&&n!=="+"&&n!=="-")throw new Error("Cannot serialize items with `"+n+"` for `options.bulletOther`, expected `*`, `+`, or `-`");if(n===t)throw new Error("Expected `bullet` (`"+t+"`) and `bulletOther` (`"+n+"`) to be different");return n}function t4(e){const t=e.options.bulletOrdered||".";if(t!=="."&&t!==")")throw new Error("Cannot serialize items with `"+t+"` for `options.bulletOrdered`, expected `.` or `)`");return t}function Cy(e){const t=e.options.rule||"*";if(t!=="*"&&t!=="-"&&t!=="_")throw new Error("Cannot serialize rules with `"+t+"` for `options.rule`, expected `*`, `-`, or `_`");return t}function n4(e,t,n,o){const r=n.enter("list"),a=n.bulletCurrent;let i=e.ordered?t4(n):jp(n);const s=e.ordered?i==="."?")":".":e4(n);let c=t&&n.bulletLastUsed?i===n.bulletLastUsed:!1;if(!e.ordered){const d=e.children?e.children[0]:void 0;if((i==="*"||i==="-")&&d&&(!d.children||!d.children[0])&&n.stack[n.stack.length-1]==="list"&&n.stack[n.stack.length-2]==="listItem"&&n.stack[n.stack.length-3]==="list"&&n.stack[n.stack.length-4]==="listItem"&&n.indexStack[n.indexStack.length-1]===0&&n.indexStack[n.indexStack.length-2]===0&&n.indexStack[n.indexStack.length-3]===0&&(c=!0),Cy(n)===i&&d){let p=-1;for(;++p<e.children.length;){const f=e.children[p];if(f&&f.type==="listItem"&&f.children&&f.children[0]&&f.children[0].type==="thematicBreak"){c=!0;break}}}}c&&(i=s),n.bulletCurrent=i;const l=n.containerFlow(e,o);return n.bulletLastUsed=i,n.bulletCurrent=a,r(),l}function o4(e){const t=e.options.listItemIndent||"one";if(t!=="tab"&&t!=="one"&&t!=="mixed")throw new Error("Cannot serialize items with `"+t+"` for `options.listItemIndent`, expected `tab`, `one`, or `mixed`");return t}function r4(e,t,n,o){const r=o4(n);let a=n.bulletCurrent||jp(n);t&&t.type==="list"&&t.ordered&&(a=(typeof t.start=="number"&&t.start>-1?t.start:1)+(n.options.incrementListMarker===!1?0:t.children.indexOf(e))+a);let i=a.length+1;(r==="tab"||r==="mixed"&&(t&&t.type==="list"&&t.spread||e.spread))&&(i=Math.ceil(i/4)*4);const s=n.createTracker(o);s.move(a+" ".repeat(i-a.length)),s.shift(i);const c=n.enter("listItem"),l=n.indentLines(n.containerFlow(e,s.current()),d);return c(),l;function d(p,f,h){return f?(h?"":" ".repeat(i))+p:(h?a:a+" ".repeat(i-a.length))+p}}function a4(e,t,n,o){const r=n.enter("paragraph"),a=n.enter("phrasing"),i=n.containerPhrasing(e,o);return a(),r(),i}const i4=Bl(["break","delete","emphasis","footnote","footnoteReference","image","imageReference","inlineCode","link","linkReference","strong","text"]);function l4(e,t,n,o){return(e.children.some(function(i){return i4(i)})?n.containerPhrasing:n.containerFlow).call(n,e,o)}function s4(e){const t=e.options.strong||"*";if(t!=="*"&&t!=="_")throw new Error("Cannot serialize strong with `"+t+"` for `options.strong`, expected `*`, or `_`");return t}Ey.peek=c4;function Ey(e,t,n,o){const r=s4(n),a=n.enter("strong"),i=n.createTracker(o);let s=i.move(r+r);return s+=i.move(n.containerPhrasing(e,{before:s,after:r,...i.current()})),s+=i.move(r+r),a(),s}function c4(e,t,n){return n.options.strong||"*"}function u4(e,t,n,o){return n.safe(e.value,o)}function d4(e){const t=e.options.ruleRepetition||3;if(t<3)throw new Error("Cannot serialize rules with repetition `"+t+"` for `options.ruleRepetition`, expected `3` or more");return t}function p4(e,t,n){const o=(Cy(n)+(n.options.ruleSpaces?" ":"")).repeat(d4(n));return n.options.ruleSpaces?o.slice(0,-1):o}const Ty={blockquote:O5,break:vg,code:H5,definition:B5,emphasis:_y,hardBreak:vg,heading:G5,html:by,image:vy,imageReference:yy,inlineCode:ky,link:Sy,linkReference:xy,list:n4,listItem:r4,paragraph:a4,root:l4,strong:Ey,text:u4,thematicBreak:p4};function f4(){return{enter:{table:h4,tableData:yg,tableHeader:yg,tableRow:g4},exit:{codeText:_4,table:m4,tableData:Hc,tableHeader:Hc,tableRow:Hc}}}function h4(e){const t=e._align;this.enter({type:"table",align:t.map(function(n){return n==="none"?null:n}),children:[]},e),this.data.inTable=!0}function m4(e){this.exit(e),this.data.inTable=void 0}function g4(e){this.enter({type:"tableRow",children:[]},e)}function Hc(e){this.exit(e)}function yg(e){this.enter({type:"tableCell",children:[]},e)}function _4(e){let t=this.resume();this.data.inTable&&(t=t.replace(/\\([\\|])/g,b4));const n=this.stack[this.stack.length-1];n.type,n.value=t,this.exit(e)}function b4(e,t){return t==="|"?t:e}function v4(e){const t=e||{},n=t.tableCellPadding,o=t.tablePipeAlign,r=t.stringLength,a=n?" ":"|";return{unsafe:[{character:"\r",inConstruct:"tableCell"},{character:`
...
`))}function c(h,v,k,T){const b=k.enter("tableCell"),m=k.enter("phrasing"),g=k.containerPhrasing(h,{...T,before:a,after:a});return m(),b(),g}function l(h,v){return D5(h,{align:v,alignDelimiters:o,padding:n,stringLength:r})}function d(h,v,k){const T=h.children;let b=-1;const m=[],g=v.enter("table");for(;++b<T.length;)m[b]=p(T[b],v,k);return g(),m}function p(h,v,k){const T=h.children;let b=-1;const m=[],g=v.enter("tableRow");for(;++b<T.length;)m[b]=c(T[b],h,v,k);return g(),m}function f(h,v,k){let T=Ty.inlineCode(h,v,k);return k.stack.includes("tableCell")&&(T=T.replace(/\|/g,"\\$&")),T}}function y4(){return{exit:{taskListCheckValueChecked:kg,taskListCheckValueUnchecked:kg,paragraph:w4}}}function k4(){return{unsafe:[{atBreak:!0,character:"-",after:"[:|-]"}],handlers:{listItem:S4}}}function kg(e){const t=this.stack[this.stack.length-2];t.type,t.checked=e.type==="taskListCheckValueChecked"}function w4(e){const t=this.stack[this.stack.length-2];if(t&&t.type==="listItem"&&typeof t.checked=="boolean"){const n=this.stack[this.stack.length-1];n.type;const o=n.children[0];if(o&&o.type==="text"){const r=t.children;let a=-1,i;for(;++a<r.length;){const s=r[a];if(s.type==="paragraph"){i=s;break}}i===n&&(o.value=o.value.slice(1),o.value.length===0?n.children.shift():n.position&&o.position&&typeof o.position.start.offset=="number"&&(o.position.start.column++,o.position.start.offset++,n.position.start=Object.assign({},o.position.start)))}}this.exit(e)}function S4(e,t,n,o){const r=e.children[0],a=typeof e.checked=="boolean"&&r&&r.type==="paragraph",i="["+(e.checked?"x":" ")+"] ",s=n.createTracker(o);a&&s.move(i);let c=Ty.listItem(e,t,n,{...o,...s.current()});return a&&(c=c.replace(/^(?:[*+-]|\d+\.)([\r\n]| {1,3})/,l)),c;function l(d){return d+i}}function x4(){return[t5(),f5(),T5(),f4(),y4()]}function C4(e){return{extensions:[n5(),h5(),A5(),v4(e),k4()]}}const E4={tokenize:D4,partial:!0},Ay={tokenize:j4,partial:!0},Py={tokenize:z4,partial:!0},Ry={tokenize:O4,partial:!0},T4={tokenize:L4,partial:!0},My={tokenize:R4,previous:jy},Dy={tokenize:M4,previous:zy},jn={tokenize:P4,previous:Oy},mn={};function A4(){return{text:mn}}let go=48;for(;go<123;)mn[go]=jn,go++,go===58?go=65:go===91&&(go=97);mn[43]=jn;mn[45]=jn;mn[46]=jn;mn[95]=jn;mn[72]=[jn,Dy];mn[104]=[jn,Dy];mn[87]=[jn,My];mn[119]=[jn,My];function P4(e,t,n){const o=this;let r,a;return i;function i(p){return!Zu(p)||!Oy.call(o,o.previous)||zp(o.events)?n(p):(e.enter("literalAutolink"),e.enter("literalAutolinkEmail"),s(p))}function s(p){return Zu(p)?(e.consume(p),s):p===64?(e.consume(p),c):n(p)}function c(p){return p===46?e.check(T4,d,l)(p):p===45||p===95||it(p)?(a=!0,e.consume(p),c):d(p)}function l(p){return e.consume(p),r=!0,c}function d(p){return a&&r&&ut(o.previous)?(e.exit("literalAutolinkEmail"),e.exit("literalAutolink"),t(p)):n(p)}}function R4(e,t,n){const o=this;return r;function r(i){return i!==87&&i!==119||!jy.call(o,o.previous)||zp(o.events)?n(i):(e.enter("literalAutolink"),e.enter("literalAutolinkWww"),e.check(E4,e.attempt(Ay,e.attempt(Py,a),n),n)(i))}function a(i){return e.exit("literalAutolinkWww"),e.exit("literalAutolink"),t(i)}}function M4(e,t,n){const o=this;let r="",a=!1;return i;function i(p){return(p===72||p===104)&&zy.call(o,o.previous)&&!zp(o.events)?(e.enter("literalAutolink"),e.enter("literalAutolinkHttp"),r+=String.fromCodePoint(p),e.consume(p),s):n(p)}function s(p){if(ut(p)&&r.length<5)return r+=String.fromCodePoint(p),e.consume(p),s;if(p===58){const f=r.toLowerCase();if(f==="http"||f==="https")return e.consume(p),c}return n(p)}function c(p){return p===47?(e.consume(p),a?l:(a=!0,c)):n(p)}function l(p){return p===null||gl(p)||Ee(p)||zo(p)||Nl(p)?n(p):e.attempt(Ay,e.attempt(Py,d),n)(p)}function d(p){return e.exit("literalAutolinkHttp"),e.exit("literalAutolink"),t(p)}}function D4(e,t,n){let o=0;return r;function r(i){return(i===87||i===119)&&o<3?(o++,e.consume(i),r):i===46&&o===3?(e.consume(i),a):n(i)}function a(i){return i===null?n(i):t(i)}}function j4(e,t,n){let o,r,a;return i;function i(l){return l===46||l===95?e.check(Ry,c,s)(l):l===null||Ee(l)||zo(l)||l!==45&&Nl(l)?c(l):(a=!0,e.consume(l),i)}function s(l){return l===95?o=!0:(r=o,o=void 0),e.consume(l),i}function c(l){return r||o||!a?n(l):t(l)}}function z4(e,t){let n=0,o=0;return r;function r(i){return i===40?(n++,e.consume(i),r):i===41&&o<n?a(i):i===33||i===34||i===38||i===39||i===41||i===42||i===44||i===46||i===58||i===59||i===60||i===63||i===93||i===95||i===126?e.check(Ry,t,a)(i):i===null||Ee(i)||zo(i)?t(i):(e.consume(i),r)}function a(i){return i===41&&o++,e.consume(i),r}}function O4(e,t,n){return o;function o(s){return s===33||s===34||s===39||s===41||s===42||s===44||s===46||s===58||s===59||s===63||s===95||s===126?(e.consume(s),o):s===38?(e.consume(s),a):s===93?(e.consume(s),r):s===60||s===null||Ee(s)||zo(s)?t(s):n(s)}function r(s){return s===null||s===40||s===91||Ee(s)||zo(s)?t(s):o(s)}function a(s){return ut(s)?i(s):n(s)}function i(s){return s===59?(e.consume(s),o):ut(s)?(e.consume(s),i):n(s)}}function L4(e,t,n){return o;function o(a){return e.consume(a),r}function r(a){return it(a)?n(a):t(a)}}function jy(e){return e===null||e===40||e===42||e===95||e===91||e===93||e===126||Ee(e)}function zy(e){return!ut(e)}function Oy(e){return!(e===47||Zu(e))}function Zu(e){return e===43||e===45||e===46||e===95||it(e)}function zp(e){let t=e.length,n=!1;for(;t--;){const o=e[t][1];if((o.type==="labelLink"||o.type==="labelImage")&&!o._balanced){n=!0;break}if(o._gfmAutolinkLiteralWalkedInto){n=!1;break}}return e.length>0&&!n&&(e[e.length-1][1]._gfmAutolinkLiteralWalkedInto=!0),n}const I4={tokenize:$4,partial:!0};function F4(){return{document:{91:{tokenize:W4,continuation:{tokenize:B4},exit:V4}},text:{91:{tokenize:H4},93:{add:"after",tokenize:U4,resolveTo:N4}}}}function U4(e,t,n){const o=this;let r=o.events.length;const a=o.parser.gfmFootnotes||(o.parser.gfmFootnotes=[]);let i;for(;r--;){const c=o.events[r][1];if(c.type==="labelImage"){i=c;break}if(c.type==="gfmFootnoteCall"||c.type==="labelLink"||c.type==="label"||c.type==="image"||c.type==="link")break}return s;function s(c){if(!i||!i._balanced)return n(c);const l=tn(o.sliceSerialize({start:i.end,end:o.now()}));return l.codePointAt(0)!==94||!a.includes(l.slice(1))?n(c):(e.enter("gfmFootnoteCallLabelMarker"),e.consume(c),e.exit("gfmFootnoteCallLabelMarker"),t(c))}}function N4(e,t){let n=e.length;for(;n--;)if(e[n][1].type==="labelImage"&&e[n][0]==="enter"){e[n][1];break}e[n+1][1].type="data",e[n+3][1].type="gfmFootnoteCallLabelMarker";const o={type:"gfmFootnoteCall",start:Object.assign({},e[n+3][1].start),end:Object.assign({},e[e.length-1][1].end)},r={type:"gfmFootnoteCallMarker",start:Object.assign({},e[n+3][1].end),end:Object.assign({},e[n+3][1].end)};r.end.column++,r.end.offset++,r.end._bufferIndex++;const a={type:"gfmFootnoteCallString",start:Object.assign({},r.end),end:Object.assign({},e[e.length-1][1].start)},i={type:"chunkString",contentType:"string",start:Object.assign({},a.start),end:Object.assign({},a.end)},s=[e[n+1],e[n+2],["enter",o,t],e[n+3],e[n+4],["enter",r,t],["exit",r,t],["enter",a,t],["enter",i,t],["exit",i,t],["exit",a,t],e[e.length-2],e[e.length-1],["exit",o,t]];return e.splice(n,e.length-n+1,...s),e}function H4(e,t,n){const o=this,r=o.parser.gfmFootnotes||(o.parser.gfmFootnotes=[]);let a=0,i;return s;function s(p){return e.enter("gfmFootnoteCall"),e.enter("gfmFootnoteCallLabelMarker"),e.consume(p),e.exit("gfmFootnoteCallLabelMarker"),c}function c(p){return p!==94?n(p):(e.enter("gfmFootnoteCallMarker"),e.consume(p),e.exit("gfmFootnoteCallMarker"),e.enter("gfmFootnoteCallString"),e.enter("chunkString").contentType="string",l)}function l(p){if(a>999||p===93&&!i||p===null||p===91||Ee(p))return n(p);if(p===93){e.exit("chunkString");const f=e.exit("gfmFootnoteCallString");return r.includes(tn(o.sliceSerialize(f)))?(e.enter("gfmFootnoteCallLabelMarker"),e.consume(p),e.exit("gfmFootnoteCallLabelMarker"),e.exit("gfmFootnoteCall"),t):n(p)}return Ee(p)||(i=!0),a++,e.consume(p),p===92?d:l}function d(p){return p===91||p===92||p===93?(e.consume(p),a++,l):l(p)}}function W4(e,t,n){const o=this,r=o.parser.gfmFootnotes||(o.parser.gfmFootnotes=[]);let a,i=0,s;return c;function c(v){return e.enter("gfmFootnoteDefinition")._container=!0,e.enter("gfmFootnoteDefinitionLabel"),e.enter("gfmFootnoteDefinitionLabelMarker"),e.consume(v),e.exit("gfmFootnoteDefinitionLabelMarker"),l}function l(v){return v===94?(e.enter("gfmFootnoteDefinitionMarker"),e.consume(v),e.exit("gfmFootnoteDefinitionMarker"),e.enter("gfmFootnoteDefinitionLabelString"),e.enter("chunkString").contentType="string",d):n(v)}function d(v){if(i>999||v===93&&!s||v===null||v===91||Ee(v))return n(v);if(v===93){e.exit("chunkString");const k=e.exit("gfmFootnoteDefinitionLabelString");return a=tn(o.sliceSerialize(k)),e.enter("gfmFootnoteDefinitionLabelMarker"),e.consume(v),e.exit("gfmFootnoteDefinitionLabelMarker"),e.exit("gfmFootnoteDefinitionLabel"),f}return Ee(v)||(s=!0),i++,e.consume(v),v===92?p:d}function p(v){return v===91||v===92||v===93?(e.consume(v),i++,d):d(v)}function f(v){return v===58?(e.enter("definitionMarker"),e.consume(v),e.exit("definitionMarker"),r.includes(a)||r.push(a),_e(e,h,"gfmFootnoteDefinitionWhitespace")):n(v)}function h(v){return t(v)}}function B4(e,t,n){return e.check($a,t,e.attempt(I4,t,n))}function V4(e){e.exit("gfmFootnoteDefinition")}function $4(e,t,n){const o=this;return _e(e,r,"gfmFootnoteDefinitionIndent",4+1);function r(a){const i=o.events[o.events.length-1];return i&&i[1].type==="gfmFootnoteDefinitionIndent"&&i[2].sliceSerialize(i[1],!0).length===4?t(a):n(a)}}function q4(e){let n=(e||{}).singleTilde;const o={tokenize:a,resolveAll:r};return n==null&&(n=!0),{text:{126:o},insideSpan:{null:[o]},attentionMarkers:{null:[126]}};function r(i,s){let c=-1;for(;++c<i.length;)if(i[c][0]==="enter"&&i[c][1].type==="strikethroughSequenceTemporary"&&i[c][1]._close){let l=c;for(;l--;)if(i[l][0]==="exit"&&i[l][1].type==="strikethroughSequenceTemporary"&&i[l][1]._open&&i[c][1].end.offset-i[c][1].start.offset===i[l][1].end.offset-i[l][1].start.offset){i[c][1].type="strikethroughSequence",i[l][1].type="strikethroughSequence";const d={type:"strikethrough",start:Object.assign({},i[l][1].start),end:Object.assign({},i[c][1].end)},p={type:"strikethroughText",start:Object.assign({},i[l][1].end),end:Object.assign({},i[c][1].start)},f=[["enter",d,s],["enter",i[l][1],s],["exit",i[l][1],s],["enter",p,s]],h=s.parser.constructs.insideSpan.null;h&&At(f,f.length,0,Hl(h,i.slice(l+1,c),s)),At(f,f.length,0,[["exit",p,s],["enter",i[c][1],s],["exit",i[c][1],s],["exit",d,s]]),At(i,l-1,c-l+3,f),c=l+f.length-2;break}}for(c=-1;++c<i.length;)i[c][1].type==="strikethroughSequenceTemporary"&&(i[c][1].type="data");return i}function a(i,s,c){const l=this.previous,d=this.events;let p=0;return f;function f(v){return l===126&&d[d.length-1][1].type!=="characterEscape"?c(v):(i.enter("strikethroughSequenceTemporary"),h(v))}function h(v){const k=_l(l);if(v===126)return p>1?c(v):(i.consume(v),p++,h);if(p<2&&!n)return c(v);const T=i.exit("strikethroughSequenceTemporary"),b=_l(v);return T._open=!b||b===2&&!!k,T._close=!k||k===2&&!!b,s(v)}}}class G4{constructor(){this.map=[]}add(t,n,o){K4(this,t,n,o)}consume(t){if(this.map.sort(function(a,i){return a[0]-i[0]}),this.map.length===0)return;let n=this.map.length;const o=[];for(;n>0;)n-=1,o.push(t.slice(this.map[n][0]+this.map[n][1]),this.map[n][2]),t.length=this.map[n][0];o.push([...t]),t.length=0;let r=o.pop();for(;r;)t.push(...r),r=o.pop();this.map.length=0}}function K4(e,t,n,o){let r=0;if(!(n===0&&o.length===0)){for(;r<e.map.length;){if(e.map[r][0]===t){e.map[r][1]+=n,e.map[r][2].push(...o);return}r+=1}e.map.push([t,n,o])}}function Q4(e,t){let n=!1;const o=[];for(;t<e.length;){const r=e[t];if(n){if(r[0]==="enter")r[1].type==="tableContent"&&o.push(e[t+1][1].type==="tableDelimiterMarker"?"left":"none");else if(r[1].type==="tableContent"){if(e[t-1][1].type==="tableDelimiterMarker"){const a=o.length-1;o[a]=o[a]==="left"?"center":"right"}}else if(r[1].type==="tableDelimiterRow")break}else r[0]==="enter"&&r[1].type==="tableDelimiterRow"&&(n=!0);t+=1}return o}function Y4(){return{flow:{null:{tokenize:X4,resolveAll:J4}}}}function X4(e,t,n){const o=this;let r=0,a=0,i;return s;function s(E){let N=o.events.length-1;for(;N>-1;){const re=o.events[N][1].type;if(re==="lineEnding"||re==="linePrefix")N--;else break}const F=N>-1?o.events[N][1].type:null,Y=F==="tableHead"||F==="tableRow"?w:c;return Y===w&&o.parser.lazy[o.now().line]?n(E):Y(E)}function c(E){return e.enter("tableHead"),e.enter("tableRow"),l(E)}function l(E){return E===124||(i=!0,a+=1),d(E)}function d(E){return E===null?n(E):te(E)?a>1?(a=0,o.interrupt=!0,e.exit("tableRow"),e.enter("lineEnding"),e.consume(E),e.exit("lineEnding"),h):n(E):me(E)?_e(e,d,"whitespace")(E):(a+=1,i&&(i=!1,r+=1),E===124?(e.enter("tableCellDivider"),e.consume(E),e.exit("tableCellDivider"),i=!0,d):(e.enter("data"),p(E)))}function p(E){return E===null||E===124||Ee(E)?(e.exit("data"),d(E)):(e.consume(E),E===92?f:p)}function f(E){return E===92||E===124?(e.consume(E),p):p(E)}function h(E){return o.interrupt=!1,o.parser.lazy[o.now().line]?n(E):(e.enter("tableDelimiterRow"),i=!1,me(E)?_e(e,v,"linePrefix",o.parser.constructs.disable.null.includes("codeIndented")?void 0:4)(E):v(E))}function v(E){return E===45||E===58?T(E):E===124?(i=!0,e.enter("tableCellDivider"),e.consume(E),e.exit("tableCellDivider"),k):x(E)}function k(E){return me(E)?_e(e,T,"whitespace")(E):T(E)}function T(E){return E===58?(a+=1,i=!0,e.enter("tableDelimiterMarker"),e.consume(E),e.exit("tableDelimiterMarker"),b):E===45?(a+=1,b(E)):E===null||te(E)?_(E):x(E)}function b(E){return E===45?(e.enter("tableDelimiterFiller"),m(E)):x(E)}function m(E){return E===45?(e.consume(E),m):E===58?(i=!0,e.exit("tableDelimiterFiller"),e.enter("tableDelimiterMarker"),e.consume(E),e.exit("tableDelimiterMarker"),g):(e.exit("tableDelimiterFiller"),g(E))}function g(E){return me(E)?_e(e,_,"whitespace")(E):_(E)}function _(E){return E===124?v(E):E===null||te(E)?!i||r!==a?x(E):(e.exit("tableDelimiterRow"),e.exit("tableHead"),t(E)):x(E)}function x(E){return n(E)}function w(E){return e.enter("tableRow"),A(E)}function A(E){return E===124?(e.enter("tableCellDivider"),e.consume(E),e.exit("tableCellDivider"),A):E===null||te(E)?(e.exit("tableRow"),t(E)):me(E)?_e(e,A,"whitespace")(E):(e.enter("data"),R(E))}function R(E){return E===null||E===124||Ee(E)?(e.exit("data"),A(E)):(e.consume(E),E===92?j:R)}function j(E){return E===92||E===124?(e.consume(E),R):R(E)}}function J4(e,t){let n=-1,o=!0,r=0,a=[0,0,0,0],i=[0,0,0,0],s=!1,c=0,l,d,p;const f=new G4;for(;++n<e.length;){const h=e[n],v=h[1];h[0]==="enter"?v.type==="tableHead"?(s=!1,c!==0&&(wg(f,t,c,l,d),d=void 0,c=0),l={type:"table",start:Object.assign({},v.start),end:Object.assign({},v.end)},f.add(n,0,[["enter",l,t]])):v.type==="tableRow"||v.type==="tableDelimiterRow"?(o=!0,p=void 0,a=[0,0,0,0],i=[0,n+1,0,0],s&&(s=!1,d={type:"tableBody",start:Object.assign({},v.start),end:Object.assign({},v.end)},f.add(n,0,[["enter",d,t]])),r=v.type==="tableDelimiterRow"?2:d?3:1):r&&(v.type==="data"||v.type==="tableDelimiterMarker"||v.type==="tableDelimiterFiller")?(o=!1,i[2]===0&&(a[1]!==0&&(i[0]=i[1],p=Ci(f,t,a,r,void 0,p),a=[0,0,0,0]),i[2]=n)):v.type==="tableCellDivider"&&(o?o=!1:(a[1]!==0&&(i[0]=i[1],p=Ci(f,t,a,r,void 0,p)),a=i,i=[a[1],n,0,0])):v.type==="tableHead"?(s=!0,c=n):v.type==="tableRow"||v.type==="tableDelimiterRow"?(c=n,a[1]!==0?(i[0]=i[1],p=Ci(f,t,a,r,n,p)):i[1]!==0&&(p=Ci(f,t,i,r,n,p)),r=0):r&&(v.type==="data"||v.type==="tableDelimiterMarker"||v.type==="tableDelimiterFiller")&&(i[3]=n)}for(c!==0&&wg(f,t,c,l,d),f.consume(t.events),n=-1;++n<t.events.length;){const h=t.events[n];h[0]==="enter"&&h[1].type==="table"&&(h[1]._align=Q4(t.events,n))}return e}function Ci(e,t,n,o,r,a){const i=o===1?"tableHeader":o===2?"tableDelimiter":"tableData",s="tableContent";n[0]!==0&&(a.end=Object.assign({},Go(t.events,n[0])),e.add(n[0],0,[["exit",a,t]]));const c=Go(t.events,n[1]);if(a={type:i,start:Object.assign({},c),end:Object.assign({},c)},e.add(n[1],0,[["enter",a,t]]),n[2]!==0){const l=Go(t.events,n[2]),d=Go(t.events,n[3]),p={type:s,start:Object.assign({},l),end:Object.assign({},d)};if(e.add(n[2],0,[["enter",p,t]]),o!==2){const f=t.events[n[2]],h=t.events[n[3]];if(f[1].end=Object.assign({},h[1].end),f[1].type="chunkText",f[1].contentType="text",n[3]>n[2]+1){const v=n[2]+1,k=n[3]-n[2]-1;e.add(v,k,[])}}e.add(n[3]+1,0,[["exit",p,t]])}return r!==void 0&&(a.end=Object.assign({},Go(t.events,r)),e.add(r,0,[["exit",a,t]]),a=void 0),a}function wg(e,t,n,o,r){const a=[],i=Go(t.events,n);r&&(r.end=Object.assign({},i),a.push(["exit",r,t])),o.end=Object.assign({},i),a.push(["exit",o,t]),e.add(n+1,0,a)}function Go(e,t){const n=e[t],o=n[0]==="enter"?"start":"end";return n[1][o]}const Z4={tokenize:tM};function eM(){return{text:{91:Z4}}}function tM(e,t,n){const o=this;return r;function r(c){return o.previous!==null||!o._gfmTasklistFirstContentOfListItem?n(c):(e.enter("taskListCheck"),e.enter("taskListCheckMarker"),e.consume(c),e.exit("taskListCheckMarker"),a)}function a(c){return Ee(c)?(e.enter("taskListCheckValueUnchecked"),e.consume(c),e.exit("taskListCheckValueUnchecked"),i):c===88||c===120?(e.enter("taskListCheckValueChecked"),e.consume(c),e.exit("taskListCheckValueChecked"),i):n(c)}function i(c){return c===93?(e.enter("taskListCheckMarker"),e.consume(c),e.exit("taskListCheckMarker"),e.exit("taskListCheck"),s):n(c)}function s(c){return te(c)?t(c):me(c)?e.check({tokenize:nM},t,n)(c):n(c)}}function nM(e,t,n){return _e(e,o,"whitespace");function o(r){return r===null?n(r):t(r)}}function oM(e){return mv([A4(),F4(),q4(e),Y4(),eM()])}const rM={};function aM(e){const t=this,n=e||rM,o=t.data(),r=o.micromarkExtensions||(o.micromarkExtensions=[]),a=o.fromMarkdownExtensions||(o.fromMarkdownExtensions=[]),i=o.toMarkdownExtensions||(o.toMarkdownExtensions=[]);r.push(oM(n)),a.push(x4()),i.push(C4(n))}var Ly={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(aR()),o=n.default;e.default=o})(Ly);const iM=Bt(Ly);var Iy={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(dy()),o=n.default;e.default=o})(Iy);const lM=Bt(Iy);var Fy={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(rR()),o=n.default;e.default=o})(Fy);const sM=Bt(Fy);var Uy={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(ZP()),o=n.default;e.default=o})(Uy);const cM=Bt(Uy);var Ny={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(oR()),o=n.default;e.default=o})(Ny);const uM=Bt(Ny);var Hy={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(tR()),o=n.default;e.default=o})(Hy);const dM=Bt(Hy);var Wy={};(function(e){var t=so;Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0;var n=t(eR()),o=n.default;e.default=o})(Wy);const pM=Bt(Wy);lo.registerLanguage("tsx",iM);lo.registerLanguage("typescript",lM);lo.registerLanguage("scss",sM);lo.registerLanguage("bash",cM);lo.registerLanguage("markdown",uM);lo.registerLanguage("json",dM);lo.registerLanguage("lua",pM);function fM({source:e}){const t=e.split(`
...
>`;function FD(){return u.jsxs("div",{className:"home-container",children:[u.jsx("img",{src:Jb,alt:"react",className:"logo"}),u.jsx("h1",{className:"title",children:"React-Tools"}),u.jsx("h2",{children:"A collection of Hooks, Components and Utilities for React"}),u.jsxs("div",{className:"npm-container",children:[u.jsx("span",{className:"npm-copy",onClick:()=>navigator.clipboard.writeText("npm i @ndriadev/react-tools"),children:"copy"}),u.jsx("p",{className:"npm-command",children:u.jsx("code",{children:"npm i @ndriadev/react-tools"})})]}),u.jsx(z,{className:"get-started",onClick:()=>{var e;return(e=document.querySelector(".container"))==null?void 0:e.scrollTo(0,0)},to:"/hooks",children:"GET STARTED"}),u.jsxs("div",{className:"features-container",children:[u.jsxs("div",{className:"cell",children:[u.jsx("div",{className:"title",children:"Typescript"}),u.jsx("div",{className:"body",children:"Written in typescript for type safety."})]}),u.jsxs("div",{className:"cell",children:[u.jsx("div",{className:"title",children:"Tree Shakable"}),u.jsx("div",{className:"body",children:"Import only that you use. Indivual import cost is tiny."})]}),u.jsxs("div",{className:"cell",children:[u.jsx("div",{className:"title",children:"Demos"}),u.jsx("div",{className:"body",children:"All implementations have a demo that allow you to try them."})]})]})]})}function UD(){const[e]=I1();return e.has("route")?u.jsx(vn,{to:`/${e.get("route")}`,replace:!0}):u.jsx(FD,{})}const ND=y.lazy(()=>H(()=>import("./ErrorBoundary-80d12dbf.js"),[]).then(e=>({default:"default"in e?e.default:e.ErrorBoundary}))),HD=y.lazy(()=>H(()=>import("./For-89d87b5a.js"),[]).then(e=>({default:"default"in e?e.default:e.For}))),WD=y.lazy(()=>H(()=>import("./LazyComponent-abf7514c.js"),[]).then(e=>({default:"default"in e?e.default:e.LazyComponent}))),BD=y.lazy(()=>H(()=>import("./Show-4b17d3dd.js"),[]).then(e=>({default:"default"in e?e.default:e.Show}))),VD=y.lazy(()=>H(()=>import("./SwitchCase-370658db.js"),[]).then(e=>({default:"default"in e?e.default:e.SwitchCase}))),$D=y.lazy(()=>H(()=>import("./UseActiveElement-00c893b9.js"),["assets/UseActiveElement-00c893b9.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseActiveElement}))),qD=y.lazy(()=>H(()=>import("./UseAnimation-9ee9357a.js"),[]).then(e=>({default:"default"in e?e.default:e.UseAnimation}))),GD=y.lazy(()=>H(()=>import("./UseAudio-a7c1289d.js"),["assets/UseAudio-a7c1289d.js","assets/createHTMLMediaElement-ca93c8ba.js"]).then(e=>({default:"default"in e?e.default:e.UseAudio}))),KD=y.lazy(()=>H(()=>import("./UseBattery-0fa54d74.js"),["assets/UseBattery-0fa54d74.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseBattery}))),QD=y.lazy(()=>H(()=>import("./UseBluetooth-6b8e5745.js"),["assets/UseBluetooth-6b8e5745.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseBluetooth}))),YD=y.lazy(()=>H(()=>import("./UseBroadcastChannel-484f4763.js"),["assets/UseBroadcastChannel-484f4763.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseBroadcastChannel}))),XD=y.lazy(()=>H(()=>import("./UseClipboard-953dc81c.js"),["assets/UseClipboard-953dc81c.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseClipboard}))),JD=y.lazy(()=>H(()=>import("./UseColorScheme-852acd47.js"),["assets/UseColorScheme-852acd47.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseColorScheme}))),ZD=y.lazy(()=>H(()=>import("./UseDebounce-1cd4f1be.js"),[]).then(e=>({default:"default"in e?e.default:e.UseDebounce}))),ej=y.lazy(()=>H(()=>import("./UseDeviceMotion-791b5f70.js"),["assets/UseDeviceMotion-791b5f70.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseDeviceMotion}))),tj=y.lazy(()=>H(()=>import("./UseDeviceOrientation-16331579.js"),["assets/UseDeviceOrientation-16331579.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseDeviceOrientation}))),nj=y.lazy(()=>H(()=>import("./UseDialogBox-a1cd3d53.js"),[]).then(e=>({default:"default"in e?e.default:e.UseDialogBox}))),oj=y.lazy(()=>H(()=>import("./UseDisplayMedia-a06c25f9.js"),["assets/UseDisplayMedia-a06c25f9.js","assets/useMediaDevices-0b770065.js","assets/useEffectOnce-9a93875c.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseDisplayMedia}))),rj=y.lazy(()=>H(()=>import("./UseDocumentPIP-4512bd78.js"),["assets/UseDocumentPIP-4512bd78.js","assets/useRerender-63bee74c.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseDocumentPIP}))),aj=y.lazy(()=>H(()=>import("./UseEyeDropper-b328c121.js"),[]).then(e=>({default:"default"in e?e.default:e.UseEyeDropper}))),ij=y.lazy(()=>H(()=>import("./UseFPS-a0c83715.js"),["assets/UseFPS-a0c83715.js","assets/useRaf-2bc9b44b.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseFPS}))),lj=y.lazy(()=>H(()=>import("./UseFetch-b24903b4.js"),[]).then(e=>({default:"default"in e?e.default:e.UseFetch}))),sj=y.lazy(()=>H(()=>import("./UseFullscreen-5c6e1caf.js"),["assets/UseFullscreen-5c6e1caf.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseFullscreen}))),cj=y.lazy(()=>H(()=>import("./UseGeolocation-1694880b.js"),["assets/UseGeolocation-1694880b.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseGeolocation}))),uj=y.lazy(()=>H(()=>import("./UseIdleCallback-022dedb3.js"),[]).then(e=>({default:"default"in e?e.default:e.UseIdleCallback}))),dj=y.lazy(()=>H(()=>import("./UseInterval-9f63dd13.js"),["assets/UseInterval-9f63dd13.js","assets/useInterval-6710f496.js"]).then(e=>({default:"default"in e?e.default:e.UseInterval}))),pj=y.lazy(()=>H(()=>import("./UseLock-75135a77.js"),[]).then(e=>({default:"default"in e?e.default:e.UseLock}))),fj=y.lazy(()=>H(()=>import("./UseMediaDevices-c26a4fb8.js"),["assets/UseMediaDevices-c26a4fb8.js","assets/useMediaDevices-0b770065.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseMediaDevices}))),hj=y.lazy(()=>H(()=>import("./UseMediaQuery-285d63da.js"),["assets/UseMediaQuery-285d63da.js","assets/useMediaQuery-a4249aa5.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseMediaQuery}))),mj=y.lazy(()=>H(()=>import("./UsePIP-324e3179.js"),["assets/UsePIP-324e3179.js","assets/mov_bbb-3ae31587.js"]).then(e=>({default:"default"in e?e.default:e.UsePIP}))),gj=y.lazy(()=>H(()=>import("./UsePermission-9cd45778.js"),["assets/UsePermission-9cd45778.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UsePermission}))),_j=y.lazy(()=>H(()=>import("./UsePopover-11237a8c.js"),["assets/UsePopover-11237a8c.js","assets/useLazyRef-fd2994f2.js","assets/useMergedRef-b14a5666.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UsePopover}))),bj=y.lazy(()=>H(()=>import("./UsePromiseSuspensible-50594758.js"),["assets/UsePromiseSuspensible-50594758.js","assets/useEffectOnce-9a93875c.js","assets/isDeepEqual-91d55382.js"]).then(e=>({default:"default"in e?e.default:e.UsePromiseSuspensible}))),vj=y.lazy(()=>H(()=>import("./UsePublishSubscribe-81fd4b5a.js"),["assets/UsePublishSubscribe-81fd4b5a.js","assets/PublishSubscribePattern-3c538608.js"]).then(e=>({default:"default"in e?e.default:e.UsePublishSubscribe}))),yj=y.lazy(()=>H(()=>import("./UseRaf-5fb77a38.js"),["assets/UseRaf-5fb77a38.js","assets/useRaf-2bc9b44b.js","assets/useResizeObserver-1420eafb.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseRaf}))),kj=y.lazy(()=>H(()=>import("./UseReducedMotion-f71a0bc4.js"),["assets/UseReducedMotion-f71a0bc4.js","assets/useReducedMotion-1144c8cf.js","assets/useMediaQuery-a4249aa5.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseReducedMotion}))),wj=y.lazy(()=>H(()=>import("./UseRemotePlayback-02c742ab.js"),["assets/UseRemotePlayback-02c742ab.js","assets/mov_bbb-3ae31587.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseRemotePlayback}))),Sj=y.lazy(()=>H(()=>import("./UseScreenWakeLock-fdac32e1.js"),["assets/UseScreenWakeLock-fdac32e1.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseScreenWakeLock}))),xj=y.lazy(()=>H(()=>import("./UseScript-56cc8557.js"),["assets/UseScript-56cc8557.js","assets/useScript-e43566ea.js","assets/useEffectOnce-9a93875c.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseScript}))),Cj=y.lazy(()=>H(()=>import("./UseShare-3d1d9653.js"),[]).then(e=>({default:"default"in e?e.default:e.UseShare}))),Ej=y.lazy(()=>H(()=>import("./UseSpeechRecognition-a493219d.js"),["assets/UseSpeechRecognition-a493219d.js","assets/usePerformAction-aa918852.js","assets/useSyncExternalStore-d7963558.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseSpeechRecognition}))),Tj=y.lazy(()=>H(()=>import("./UseSpeechSynthesis-58c7678f.js"),["assets/UseSpeechSynthesis-58c7678f.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseSpeechSynthesis}))),Aj=y.lazy(()=>H(()=>import("./UseTextSelection-27bca718.js"),["assets/UseTextSelection-27bca718.js","assets/useSyncExternalStore-d7963558.js","assets/isDeepEqual-91d55382.js"]).then(e=>({default:"default"in e?e.default:e.UseTextSelection}))),Pj=y.lazy(()=>H(()=>import("./UseThrottle-6ede2639.js"),[]).then(e=>({default:"default"in e?e.default:e.UseThrottle}))),Rj=y.lazy(()=>H(()=>import("./UseTimeout-2a68240e.js"),[]).then(e=>({default:"default"in e?e.default:e.UseTimeout}))),Mj=y.lazy(()=>H(()=>import("./UseTitle-59f5f720.js"),[]).then(e=>({default:"default"in e?e.default:e.UseTitle}))),Dj=y.lazy(()=>H(()=>import("./UseVibrate-f600b97f.js"),[]).then(e=>({default:"default"in e?e.default:e.UseVibrate}))),jj=y.lazy(()=>H(()=>import("./UseVideo-165d931d.js"),["assets/UseVideo-165d931d.js","assets/mov_bbb-3ae31587.js","assets/createHTMLMediaElement-ca93c8ba.js"]).then(e=>({default:"default"in e?e.default:e.UseVideo}))),zj=y.lazy(()=>H(()=>import("./UseWebWorker-1621d634.js"),["assets/UseWebWorker-1621d634.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseWebWorker}))),Oj=y.lazy(()=>H(()=>import("./UseWebWorkerFn-bf992909.js"),["assets/UseWebWorkerFn-bf992909.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseWebWorkerFn}))),Lj=y.lazy(()=>H(()=>import("./UseBeforeUnload-6e6764e7.js"),["assets/UseBeforeUnload-6e6764e7.js","assets/useEventListener-cae6a374.js","assets/useMemoizedFn-70dbf8dc.js"]).then(e=>({default:"default"in e?e.default:e.UseBeforeUnload}))),Ij=y.lazy(()=>H(()=>import("./UseClickOutside-f5e13cc4.js"),["assets/UseClickOutside-f5e13cc4.js","assets/useEventListener-cae6a374.js","assets/useMemoizedFn-70dbf8dc.js"]).then(e=>({default:"default"in e?e.default:e.UseClickOutside}))),Fj=y.lazy(()=>H(()=>import("./UseContextMenu-22bd6e51.js"),["assets/UseContextMenu-22bd6e51.js","assets/useEventListener-cae6a374.js","assets/useMemoizedFn-70dbf8dc.js"]).then(e=>({default:"default"in e?e.default:e.UseContextMenu}))),Uj=y.lazy(()=>H(()=>import("./UseDocumentVisibility-50a55e21.js"),["assets/UseDocumentVisibility-50a55e21.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseDocumentVisibility}))),Nj=y.lazy(()=>H(()=>import("./UseDoubleClick-8d842d84.js"),[]).then(e=>({default:"default"in e?e.default:e.UseDoubleClick}))),Hj=y.lazy(()=>H(()=>import("./UseEventDispatcher-fcb32cfc.js"),["assets/UseEventDispatcher-fcb32cfc.js","assets/useMemoizedFn-70dbf8dc.js","assets/useEventListener-cae6a374.js"]).then(e=>({default:"default"in e?e.default:e.UseEventDispatcher}))),Wj=y.lazy(()=>H(()=>import("./UseEventListener-aa5ae388.js"),["assets/UseEventListener-aa5ae388.js","assets/useEventListener-cae6a374.js","assets/useMemoizedFn-70dbf8dc.js"]).then(e=>({default:"default"in e?e.default:e.UseEventListener}))),Bj=y.lazy(()=>H(()=>import("./UseEvents-da5700a2.js"),["assets/UseEvents-da5700a2.js","assets/useEvents-916bdadb.js"]).then(e=>({default:"default"in e?e.default:e.UseEvents}))),Vj=y.lazy(()=>H(()=>import("./UseHotKeys-024d59a0.js"),["assets/UseHotKeys-024d59a0.js","assets/useEventListener-cae6a374.js","assets/useMemoizedFn-70dbf8dc.js"]).then(e=>({default:"default"in e?e.default:e.UseHotKeys}))),$j=y.lazy(()=>H(()=>import("./UseHover-7dd7ee44.js"),["assets/UseHover-7dd7ee44.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseHover}))),qj=y.lazy(()=>H(()=>import("./UseInfiniteScroll-8765403d.js"),["assets/UseInfiniteScroll-8765403d.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseInfiniteScroll}))),Gj=y.lazy(()=>H(()=>import("./UseIntersectionObserver-0a915d6d.js"),["assets/UseIntersectionObserver-0a915d6d.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseIntersectionObserver}))),Kj=y.lazy(()=>H(()=>import("./UseIsOnline-ef95e4c8.js"),["assets/UseIsOnline-ef95e4c8.js","assets/useNetwork-590ca8a1.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseIsOnline}))),Qj=y.lazy(()=>H(()=>import("./UseLongPress-796d25a8.js"),[]).then(e=>({default:"default"in e?e.default:e.UseLongPress}))),Yj=y.lazy(()=>H(()=>import("./UseMeasure-251f3ae2.js"),["assets/UseMeasure-251f3ae2.js","assets/useResizeObserver-1420eafb.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseMeasure}))),Xj=y.lazy(()=>H(()=>import("./UseMouse-dc3408e6.js"),["assets/UseMouse-dc3408e6.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseMouse}))),Jj=y.lazy(()=>H(()=>import("./UseMutationObserver-03867b7d.js"),["assets/UseMutationObserver-03867b7d.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseMutationObserver}))),Zj=y.lazy(()=>H(()=>import("./UseNetwork-c70cd785.js"),["assets/UseNetwork-c70cd785.js","assets/useNetwork-590ca8a1.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseNetwork}))),ez=y.lazy(()=>H(()=>import("./UsePerformAction-a824e79a.js"),["assets/UsePerformAction-a824e79a.js","assets/usePerformAction-aa918852.js","assets/useScript-e43566ea.js","assets/useEffectOnce-9a93875c.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UsePerformAction}))),tz=y.lazy(()=>H(()=>import("./UsePinchZoom-8be3c851.js"),["assets/UsePinchZoom-8be3c851.js","assets/useEventListener-cae6a374.js","assets/useMemoizedFn-70dbf8dc.js"]).then(e=>({default:"default"in e?e.default:e.UsePinchZoom}))),nz=y.lazy(()=>H(()=>import("./UsePointerLock-69700292.js"),[]).then(e=>({default:"default"in e?e.default:e.UsePointerLock}))),oz=y.lazy(()=>H(()=>import("./UseResizeObserver-42d56815.js"),["assets/UseResizeObserver-42d56815.js","assets/useResizeObserver-1420eafb.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseResizeObserver}))),rz=y.lazy(()=>H(()=>import("./UseResponsive-3ddda1a6.js"),["assets/UseResponsive-3ddda1a6.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseResponsive}))),az=y.lazy(()=>H(()=>import("./UseScreen-5a9970ba.js"),["assets/UseScreen-5a9970ba.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseScreen}))),iz=y.lazy(()=>H(()=>import("./UseScrollIntoView-4f04412d.js"),["assets/UseScrollIntoView-4f04412d.js","assets/useEventListener-cae6a374.js","assets/useMemoizedFn-70dbf8dc.js","assets/useReducedMotion-1144c8cf.js","assets/useMediaQuery-a4249aa5.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseScrollIntoView}))),lz=y.lazy(()=>H(()=>import("./UseSwipe-ceef4071.js"),["assets/UseSwipe-ceef4071.js","assets/useEventListener-cae6a374.js","assets/useMemoizedFn-70dbf8dc.js"]).then(e=>({default:"default"in e?e.default:e.UseSwipe}))),sz=y.lazy(()=>H(()=>import("./UseVisible-cac990c7.js"),["assets/UseVisible-cac990c7.js","assets/useEffectOnce-9a93875c.js","assets/useSyncExternalStore-d7963558.js"]).then(e=>({default:"default"in e?e.default:e.UseVisible}))),cz=y.lazy(()=>H(()=>import("./UseEffectCompare-a8a5c2a2.js"),[]).then(e=>({default:"default"in e?e.default:e.UseEffectCompare}))),uz=y.lazy(()=>H(()=>import("./UseEffectDeepCompare-65abdfe5.js"),["assets/UseEffectDeepCompare-65abdfe5.js","assets/isDeepEqual-91d55382.js"]).then(e=>({default:"default"in e?e.default:e.UseEffectDeepCompare}))),dz=y.lazy(()=>H(()=>import("./UseEffectOnce-0fbe2601.js"),["assets/UseEffectOnce-0fbe2601.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseEffectOnce}))),pz=y.lazy(()=>H(()=>import("./UseIsMounted-1f813aad.js"),["assets/UseIsMounted-1f813aad.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseIsMounted}))),fz=y.lazy(()=>H(()=>import("./UseLogger-3ef2b053.js"),[]).then(e=>({default:"default"in e?e.default:e.UseLogger}))),hz=y.lazy(()=>H(()=>import("./UseRerender-70fc8947.js"),["assets/UseRerender-70fc8947.js","assets/useRerender-63bee74c.js"]).then(e=>({default:"default"in e?e.default:e.UseRerender}))),mz=y.lazy(()=>H(()=>import("./UseCallbackCompare-6f33a03f.js"),[]).then(e=>({default:"default"in e?e.default:e.UseCallbackCompare}))),gz=y.lazy(()=>H(()=>import("./UseCallbackDeepCompare-1cf80094.js"),["assets/UseCallbackDeepCompare-1cf80094.js","assets/isDeepEqual-91d55382.js"]).then(e=>({default:"default"in e?e.default:e.UseCallbackDeepCompare}))),_z=y.lazy(()=>H(()=>import("./UseLazyRef-456c7d9c.js"),["assets/UseLazyRef-456c7d9c.js","assets/useRerender-63bee74c.js","assets/useInterval-6710f496.js","assets/useLazyRef-fd2994f2.js"]).then(e=>({default:"default"in e?e.default:e.UseLazyRef}))),bz=y.lazy(()=>H(()=>import("./UseMemoCompare-fb5cb23e.js"),[]).then(e=>({default:"default"in e?e.default:e.UseMemoCompare}))),vz=y.lazy(()=>H(()=>import("./UseMemoDeepCompare-d16da39e.js"),["assets/UseMemoDeepCompare-d16da39e.js","assets/isDeepEqual-91d55382.js"]).then(e=>({default:"default"in e?e.default:e.UseMemoDeepCompare}))),yz=y.lazy(()=>H(()=>import("./UseMemoizedFn-76f56547.js"),["assets/UseMemoizedFn-76f56547.js","assets/useMemoizedFn-70dbf8dc.js"]).then(e=>({default:"default"in e?e.default:e.UseMemoizedFn}))),kz=y.lazy(()=>H(()=>import("./UseMergedRef-572bea20.js"),["assets/UseMergedRef-572bea20.js","assets/useResizeObserver-1420eafb.js","assets/useEffectOnce-9a93875c.js","assets/useMergedRef-b14a5666.js"]).then(e=>({default:"default"in e?e.default:e.UseMergedRef}))),wz=y.lazy(()=>H(()=>import("./CreatePubSubStore-2a45c387.js"),["assets/CreatePubSubStore-2a45c387.js","assets/useSyncExternalStore-d7963558.js","assets/PublishSubscribePattern-3c538608.js","assets/useLazyRef-fd2994f2.js","assets/isDeepEqual-91d55382.js"]).then(e=>({default:"default"in e?e.default:e.CreatePubSubStore}))),Sz=y.lazy(()=>H(()=>import("./UseArray-baa10169.js"),[]).then(e=>({default:"default"in e?e.default:e.UseArray}))),xz=y.lazy(()=>H(()=>import("./UseDerivedState-10783c63.js"),[]).then(e=>({default:"default"in e?e.default:e.UseDerivedState}))),Cz=y.lazy(()=>H(()=>import("./UseLocalStorageState-065dc18f.js"),["assets/UseLocalStorageState-065dc18f.js","assets/useEvents-916bdadb.js","assets/useMemoizedFn-70dbf8dc.js","assets/useEffectOnce-9a93875c.js"]).then(e=>({default:"default"in e?e.default:e.UseLocalStorageState}))),Ez=y.lazy(()=>H(()=>import("./UseMap-08b11416.js"),[]).then(e=>({default:"default"in e?e.default:e.UseMap}))),Tz=y.lazy(()=>H(()=>import("./UsePrevious-8f1c3b69.js"),[]).then(e=>({default:"default"in e?e.default:e.UsePrevious}))),Az=y.lazy(()=>H(()=>import("./UseProxyState-7cf0050d.js"),[]).then(e=>({default:"default"in e?e.default:e.UseProxyState}))),Pz=y.lazy(()=>H(()=>import("./UseSessionStorageState-7066eed2.js"),["assets/UseSessionStorageState-7066eed2.js","assets/useEvents-916bdadb.js","assets/useMemoizedFn-70dbf8dc.js"]).then(e=>({default:"default"in e?e.default:e.UseSessionStorageState}))),Rz=y.lazy(()=>H(()=>import("./UseSet-513b1a0b.js"),[]).then(e=>({default:"default"in e?e.default:e.UseSet}))),Mz=y.lazy(()=>H(()=>import("./UseStateGetReset-9b6e8011.js"),["assets/UseStateGetReset-9b6e8011.js","assets/useMemoizedFn-70dbf8dc.js"]).then(e=>({default:"default"in e?e.default:e.UseStateGetReset}))),Dz=y.lazy(()=>H(()=>import("./UseStateHistory-f1a854fd.js"),[]).then(e=>({default:"default"in e?e.default:e.UseStateHistory}))),jz=y.lazy(()=>H(()=>import("./UseStateValidator-b9233d84.js"),["assets/UseStateValidator-b9233d84.js","assets/useMemoizedFn-70dbf8dc.js"]).then(e=>({default:"default"in e?e.default:e.UseStateValidator})));function zz(){const e=M1([{path:"/",element:u.jsx(Q1,{}),children:[{index:!0,element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(UD,{})})},{path:"hooks",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/hooks/state/createPubSubStore",replace:!0})},{path:"state",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/createPubSubStore",replace:!0})},{path:"createPubSubStore",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:kM,component:u.jsx(wz,{})})})},{path:"useArray",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:NM,component:u.jsx(Sz,{})})})},{path:"useDerivedState",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:e9,component:u.jsx(xz,{})})})},{path:"useLocalStorageState",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:j9,component:u.jsx(Cz,{})})})},{path:"useMap",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:I9,component:u.jsx(Ez,{})})})},{path:"usePrevious",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:eD,component:u.jsx(Tz,{})})})},{path:"useProxyState",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:nD,component:u.jsx(Az,{})})})},{path:"useReducerGetReset",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:iD})})},{path:"useReducerHistory",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:lD})})},{path:"useReducerHistoryGetter",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:sD})})},{path:"useSessionStorageState",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:_D,component:u.jsx(Pz,{})})})},{path:"useSet",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:bD,component:u.jsx(Rz,{})})})},{path:"useStateGetReset",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:wD,component:u.jsx(Mz,{})})})},{path:"useStateHistory",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:SD,component:u.jsx(Dz,{})})})},{path:"useStateHistoryGetter",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:xD})})},{path:"useStateValidator",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:CD,component:u.jsx(jz,{})})})},{path:"useSyncExternalStore",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:TD})})}]},{path:"lifecycle",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/useDeferredValue",replace:!0})},{path:"useDeferredValue",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:ZM})})},{path:"useEffectCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:s9,component:u.jsx(cz,{})})})},{path:"useEffectDeepCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:c9,component:u.jsx(uz,{})})})},{path:"useEffectOnce",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:u9,component:u.jsx(dz,{})})})},{path:"useIsMounted",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:T9,component:u.jsx(pz,{})})})},{path:"useLayoutEffectCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:P9})})},{path:"useLayoutEffectDeepCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:R9})})},{path:"useLayoutEffectOnce",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:M9})})},{path:"useLogger",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:O9,component:u.jsx(fz,{})})})},{path:"useRerender",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:uD,component:u.jsx(hz,{})})})}]},{path:"performance",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/useCallbackCompare",replace:!0})},{path:"useCallbackCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:qM,component:u.jsx(mz,{})})})},{path:"useCallbackDeepCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:GM,component:u.jsx(gz,{})})})},{path:"useId",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:w9})})},{path:"useLazyRef",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:D9,component:u.jsx(_z,{})})})},{path:"useMemoCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:H9,component:u.jsx(bz,{})})})},{path:"useMemoDeepCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:W9,component:u.jsx(vz,{})})})},{path:"useMemoizedFn",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:B9,component:u.jsx(yz,{})})})},{path:"useMergedRef",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:V9,component:u.jsx(kz,{})})})}]},{path:"events",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/useBeforeUnload",replace:!0})},{path:"useBeforeUnload",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:BM,component:u.jsx(Lj,{})})})},{path:"useClickOutside",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:KM,component:u.jsx(Ij,{})})})},{path:"useContextMenu",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:XM,component:u.jsx(Fj,{})})})},{path:"useDocumentVisibility",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:i9,component:u.jsx(Uj,{})})})},{path:"useDoubleClick",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:l9,component:u.jsx(Nj,{})})})},{path:"useEventDispatcher",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:d9,component:u.jsx(Hj,{})})})},{path:"useEventListener",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:p9,component:u.jsx(Wj,{})})})},{path:"useEvents",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:h9,component:u.jsx(Bj,{})})})},{path:"useHotKeys",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:y9,component:u.jsx(Vj,{})})})},{path:"useHover",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:k9,component:u.jsx($j,{})})})},{path:"useInfiniteScroll",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:x9,component:u.jsx(qj,{})})})},{path:"useIntersectionObserver",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:C9,component:u.jsx(Gj,{})})})},{path:"useIsOnline",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:A9,component:u.jsx(Kj,{})})})},{path:"useLongPress",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:L9,component:u.jsx(Qj,{})})})},{path:"useMeasure",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:F9,component:u.jsx(Yj,{})})})},{path:"useMouse",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:$9,component:u.jsx(Xj,{})})})},{path:"useMutationObserver",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:q9,component:u.jsx(Jj,{})})})},{path:"useNetwork",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:G9,component:u.jsx(Zj,{})})})},{path:"usePerformAction",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:Q9,component:u.jsx(ez,{})})})},{path:"usePinchZoom",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:X9,component:u.jsx(tz,{})})})},{path:"usePointerLock",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:J9,component:u.jsx(nz,{})})})},{path:"useResizeObserver",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:dD,component:u.jsx(oz,{})})})},{path:"useResponsive",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:pD,component:u.jsx(rz,{})})})},{path:"useScreen",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:fD,component:u.jsx(az,{})})})},{path:"useScrollIntoView",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:gD,component:u.jsx(iz,{})})})},{path:"useSwipe",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:ED,component:u.jsx(lz,{})})})},{path:"useVisible",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:zD,component:u.jsx(sz,{})})})}]},{path:"api-dom",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/useActiveElement",replace:!0})},{path:"useActiveElement",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:FM,component:u.jsx($D,{})})})},{path:"useAnimation",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:UM,component:u.jsx(qD,{})})})},{path:"useAudio",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:HM,component:u.jsx(GD,{})})})},{path:"useBattery",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:WM,component:u.jsx(KD,{})})})},{path:"useBluetooth",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:VM,component:u.jsx(QD,{})})})},{path:"useBroadcastChannel",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:$M,component:u.jsx(YD,{})})})},{path:"useClipboard",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:QM,component:u.jsx(XD,{})})})},{path:"useColorScheme",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:YM,component:u.jsx(JD,{})})})},{path:"useDebounce",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:JM,component:u.jsx(ZD,{})})})},{path:"useDeviceMotion",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:t9,component:u.jsx(ej,{})})})},{path:"useDeviceOrientation",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:n9,component:u.jsx(tj,{})})})},{path:"useDialogBox",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:o9,component:u.jsx(nj,{})})})},{path:"useDisplayMedia",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:r9,component:u.jsx(oj,{})})})},{path:"useDocumentPIP",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:a9,component:u.jsx(rj,{})})})},{path:"useEventSource",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:f9})})},{path:"useEyeDropper",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:m9,component:u.jsx(aj,{})})})},{path:"useFetch",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:_9,component:u.jsx(lj,{})})})},{path:"useFPS",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:g9,component:u.jsx(ij,{})})})},{path:"useFullscreen",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:b9,component:u.jsx(sj,{})})})},{path:"useGeolocation",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:v9,component:u.jsx(cj,{})})})},{path:"useIdleCallback",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:S9,component:u.jsx(uj,{})})})},{path:"useInterval",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:E9,component:u.jsx(dj,{})})})},{path:"useLock",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:z9,component:u.jsx(pj,{})})})},{path:"useMediaDevices",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:U9,component:u.jsx(fj,{})})})},{path:"useMediaQuery",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:N9,component:u.jsx(hj,{})})})},{path:"usePermission",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:Y9,component:u.jsx(gj,{})})})},{path:"usePIP",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:K9,component:u.jsx(mj,{})})})},{path:"usePopover",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:Z9,component:u.jsx(_j,{})})})},{path:"usePromiseSuspensible",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:tD,component:u.jsx(bj,{})})})},{path:"usePublishSubscribe",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:oD,component:u.jsx(vj,{})})})},{path:"useRaf",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:rD,component:u.jsx(yj,{})})})},{path:"useReducedMotion",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:aD,component:u.jsx(kj,{})})})},{path:"useRemotePlayback",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:cD,component:u.jsx(wj,{})})})},{path:"useScreenWakeLock",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:hD,component:u.jsx(Sj,{})})})},{path:"useScript",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:mD,component:u.jsx(xj,{})})})},{path:"useShare",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:vD,component:u.jsx(Cj,{})})})},{path:"useSpeechRecognition",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:yD,component:u.jsx(Ej,{})})})},{path:"useSpeechSynthesis",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:kD,component:u.jsx(Tj,{})})})},{path:"useTextSelection",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:AD,component:u.jsx(Aj,{})})})},{path:"useThrottle",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:PD,component:u.jsx(Pj,{})})})},{path:"useTimeout",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:RD,component:u.jsx(Rj,{})})})},{path:"useTitle",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:MD,component:u.jsx(Mj,{})})})},{path:"useVibrate",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:DD,component:u.jsx(Dj,{})})})},{path:"useVideo",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:jD,component:u.jsx(jj,{})})})},{path:"useWebSocket",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:OD})})},{path:"useWebWorker",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:LD,component:u.jsx(zj,{})})})},{path:"useWebWorkerFn",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:ID,component:u.jsx(Oj,{})})})}]}]},{path:"components",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/components/ErrorBoundary",replace:!0})},{path:"ErrorBoundary",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:hM,component:u.jsx(ND,{})})})},{path:"For",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:mM,component:u.jsx(HD,{})})})},{path:"LazyComponent",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:gM,component:u.jsx(WD,{})})})},{path:"Show",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:_M,component:u.jsx(BD,{})})})},{path:"SwitchCase",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:bM,component:u.jsx(VD,{})})})}]},{path:"utils",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(In,{})}),children:[{index:!0,element:u.jsx(vn,{to:"/utils/alphanumericCompare",replace:!0})},{path:"alphanumericCompare",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:vM})})},{path:"changeStringCase",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:yM})})},{path:"defaultSerializer",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:wM})})},{path:"detectBrowser",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:SM})})},{path:"getBase64",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:xM})})},{path:"getKeyObjectFromValue",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:CM})})},{path:"getObjectFromDottedString",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:EM})})},{path:"hotKeyHandler",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:TM})})},{path:"isAsync",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:AM})})},{path:"isClient",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:PM})})},{path:"isDeepEqual",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:RM})})},{path:"isMouseEvent",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:MM})})},{path:"isShallowEqual",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:DM})})},{path:"isTouchEvent",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:jM})})},{path:"lazy",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:zM})})},{path:"mergeObjects",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:OM})})},{path:"removeDuplicatedFromArrayObjects",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:LM})})},{path:"removePropertiesFromArrayObjects",element:u.jsx(y.Suspense,{fallback:u.jsx(D,{}),children:u.jsx(O,{markdown:IM})})}]}]}]);return u.jsx(w1,{router:e})}function Oz(){return u.jsx(zz,{})}Wc.createRoot(document.getElementById("root")).render(u.jsx(y.StrictMode,{children:u.jsx(Oz,{})}));export{H as _,Lb as a,u as j,y as r};
