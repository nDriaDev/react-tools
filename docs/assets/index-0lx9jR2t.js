...
>`,yj=`# removePropertiesFromArrayObjects
...
>`,wD="# Utility Types\n\nTypescript utility types for specified use cases.\n\n## NestedKeyOf\n\nUtility type that constructs a type by picking all properties and nested proprerties from __`T`__ in form _`property.nestedProprerty`_.\n```tsx\ntype NestedKeyOf<T extends Record<string, unknown>>\n```\n\n## ErrorModel\n\nUtility type that constructs an object from __`T`__ and whose property values are _`boolean`_.\n```tsx\ntype ErrorModel<T extends object>\n```\n\n## SelectivePartial\n\nUtility type that works like __Partial__ but allows to specify which properties set to optional.\n```tsx\ntype SelectivePartial<T extends object, E extends keyof T>\n```\n\n## RecursivePartial\n\nUtility type that works like __Partial__ but set nested properties to optional also.\n```tsx\ntype RecursivePartial<T extends object>\n```\n\n## Optional\n\nUtility type that constructs a type that is __`T`__ or __`E`__, if specified otherwise __`null`__.\n```tsx\ntype Optional<T = unknown, E = null>\n```\n\n## DependencyListTyped\n\nUtility type that works like __DependencyList__ react type but it can be specified dependencies list element types.\n```tsx\ntype DependencyListTyped<T = unknown>\n```\n\n## Union\n\nUtility type that given an array constructs union type from array elements type.\n```tsx\ntype Union<T extends unknown[]>\n```\n\n## ExtractTail\n\nUtility type that given an array extracts a new array with all elements from array expect first.\n```tsx\ntype ExtractTail<T extends unknown[]>\n```\n\n## ExtractMiddle\n\nUtility type that given an array extracts a new array with all elements from array expect first and last.\n```tsx\ntype ExtractMiddle<T extends unknown[]>\n```\n\n## ExtractHead\n\nUtility type that given an array extracts a new array with all elements from array expect last.\n```tsx\ntype ExtractHead<T extends unknown[]>\n```\n\n## PartialRecord\n\nUtility type that constructs a record with all properties set to optional.\n```tsx\ntype PartialRecord<K extends keyof any, T>\n```\n\n## ArrayMinLength1\n\nUtility type that constructs an array of __`T`__ with one element at least.\n```tsx\ntype ArrayMinLength1<T>\n```\n\n## LanguageBCP47Tags\n\nUtility type for Language BCP-47 tags.\n```tsx\ntype LanguageBCP47Tags\n```\n\n## TypedArray\n\nUtility type for __`Typed Arrays`__.\n```tsx\ntype TypedArray\n```\n\n## KeyboardEventCode\n\nUtility type for __`Keyboard Event Code`__\n```tsx\ntype KeyboardEventCode\n```\n\n",SD="react-tools-demo",xD="1.10.1",CD="module",ED={generator:"node scripts/generateMarkdown.js && node scripts/generateRouter.js && node scripts/generateMainLayout.js",dev:"pnpm --filter react-tools-demo run generator && vite","dev:no-docs":"node scripts/generateRouter.js no-docs && node scripts/generateMainLayout.js && vite",build:"pnpm --filter react-tools-demo run generator && tsc && vite build && rm -rf ../../docs && mv ./dist ./../../docs",lint:"eslint . --ext ts,tsx --report-unused-disable-directives --max-warnings 0",preview:"vite build && vite preview"},TD={react:"^18.2.0","react-dom":"^18.2.0","react-transition-group":"^4.4.5"},AD={"@types/react":"^18.2.55","@types/react-dom":"^18.2.19","@types/react-syntax-highlighter":"^15.5.11","@types/react-transition-group":"^4.4.10","@typescript-eslint/eslint-plugin":"^7.12.0","@typescript-eslint/parser":"^7.12.0","@vitejs/plugin-react":"^4.2.1",eslint:"^8.56.0","eslint-plugin-react-hooks":"^4.6.0","eslint-plugin-react-refresh":"^0.4.5","react-markdown":"^9.0.1","react-router-dom":"^6.22.0","react-syntax-highlighter":"^15.5.0","remark-gfm":"^4.0.0",typescript:"^5.4.5",vite:"^5.0.12","vite-plugin-mkcert":"^1.17.3"},PD={name:SD,private:!0,version:xD,type:CD,scripts:ED,dependencies:TD,devDependencies:AD};function RD(){return u.jsxs("div",{className:"home-container",children:[u.jsx(z,{to:"https://github.com/nDriaDev/react-tools",children:u.jsx("img",{src:fv,alt:"react",className:"logo"})}),u.jsx("h1",{className:"title",style:{marginBottom:0},translate:"no",children:"React-Tools"}),u.jsx("h2",{className:"h3 version",children:PD.version}),u.jsx("h3",{className:"title h2",style:{textAlign:"center"},children:"A collection of Hooks, Components, Utilities and Types for React"}),u.jsx("div",{className:"npm-container",children:u.jsxs("p",{className:"npm-command",translate:"no",children:[u.jsx("code",{children:"npm i @ndriadev/react-tools"}),u.jsx("button",{className:"npm-copy",type:"button","aria-label":"Copy install command line",onClick:()=>(navigator.clipboard.writeText("npm i @ndriadev/react-tools"),document.activeElement.blur()),children:u.jsx("svg",{"aria-hidden":"true",focusable:"false","data-prefix":"far","data-icon":"copy",role:"img",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 448 512",children:u.jsx("path",{d:"M433.941 65.941l-51.882-51.882A48 48 0 0 0 348.118 0H176c-26.51 0-48 21.49-48 48v48H48c-26.51 0-48 21.49-48 48v320c0 26.51 21.49 48 48 48h224c26.51 0 48-21.49 48-48v-48h80c26.51 0 48-21.49 48-48V99.882a48 48 0 0 0-14.059-33.941zM266 464H54a6 6 0 0 1-6-6V150a6 6 0 0 1 6-6h74v224c0 26.51 21.49 48 48 48h96v42a6 6 0 0 1-6 6zm128-96H182a6 6 0 0 1-6-6V54a6 6 0 0 1 6-6h106v88c0 13.255 10.745 24 24 24h88v202a6 6 0 0 1-6 6zm6-256h-64V48h9.632c1.591 0 3.117.632 4.243 1.757l48.368 48.368a6 6 0 0 1 1.757 4.243V112z"})})})]})}),u.jsx(z,{className:"get-started",onClick:()=>{var e;return(e=document.querySelector(".container"))==null?void 0:e.scrollTo(0,0)},to:"/hooks",children:"GET STARTED"}),u.jsxs("div",{className:"features-container",children:[u.jsxs("div",{className:"cell cell1",children:[u.jsx("div",{className:"title",translate:"no",children:"Typescript"}),u.jsx("div",{className:"body",children:"Written in typescript for type safety."})]}),u.jsxs("div",{className:"cell cell2",children:[u.jsx("div",{className:"title",translate:"no",children:"Tree Shakable"}),u.jsx("div",{className:"body",children:"Import only that you use. Indivual import cost is tiny."})]}),u.jsxs("div",{className:"cell cell3",children:[u.jsx("div",{className:"title",translate:"no",children:"Demos"}),u.jsx("div",{className:"body",children:"All implementations have a demo that allow you to try them."})]}),u.jsxs("div",{className:"footer",children:[u.jsx(z,{to:"https://github.com/nDriaDev/react-tools",children:u.jsx("img",{src:pv,className:"img",alt:"github"})}),u.jsx(z,{to:"https://ndria.dev",target:"_blank",children:"nDriaDev"})]})]})]})}function MD(){const[e]=dS();return e.has("route")?u.jsx(pn,{to:`/${e.get("route")}`,replace:!0}):u.jsx(RD,{})}const jD=v.lazy(()=>N(()=>import("./ErrorBoundary--1zq4UoE.js"),__vite__mapDeps([0,1])).then(e=>({default:"default"in e?e.default:e.ErrorBoundary}))),DD=v.lazy(()=>N(()=>import("./For-_cWFDFQ2.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.For}))),zD=v.lazy(()=>N(()=>import("./LazyComponent-sYqxmZAZ.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.LazyComponent}))),OD=v.lazy(()=>N(()=>import("./Show-s5lyERPZ.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.Show}))),LD=v.lazy(()=>N(()=>import("./SwitchCase-muXpSem9.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.SwitchCase}))),ID=v.lazy(()=>N(()=>import("./UseActiveElement-2hjKditX.js"),__vite__mapDeps([2,3])).then(e=>({default:"default"in e?e.default:e.UseActiveElement}))),FD=v.lazy(()=>N(()=>import("./UseAnimation-8S9kvnWX.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseAnimation}))),UD=v.lazy(()=>N(()=>import("./UseAudio-QsTm0209.js"),__vite__mapDeps([4,5])).then(e=>({default:"default"in e?e.default:e.UseAudio}))),ND=v.lazy(()=>N(()=>import("./UseBattery-7XQZkJgL.js"),__vite__mapDeps([6,3])).then(e=>({default:"default"in e?e.default:e.UseBattery}))),HD=v.lazy(()=>N(()=>import("./UseBluetooth-tNzVV7Ez.js"),__vite__mapDeps([7,3])).then(e=>({default:"default"in e?e.default:e.UseBluetooth}))),WD=v.lazy(()=>N(()=>import("./UseBroadcastChannel-KTyZA0W6.js"),__vite__mapDeps([8,3])).then(e=>({default:"default"in e?e.default:e.UseBroadcastChannel}))),BD=v.lazy(()=>N(()=>import("./UseClipboard-7pNf1DGX.js"),__vite__mapDeps([9,3])).then(e=>({default:"default"in e?e.default:e.UseClipboard}))),VD=v.lazy(()=>N(()=>import("./UseColorScheme-CzpGbyvT.js"),__vite__mapDeps([10,3])).then(e=>({default:"default"in e?e.default:e.UseColorScheme}))),$D=v.lazy(()=>N(()=>import("./UseDebounce-U8gzxun7.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseDebounce}))),qD=v.lazy(()=>N(()=>import("./UseDeviceMotion-Tquk0Bcy.js"),__vite__mapDeps([11,3])).then(e=>({default:"default"in e?e.default:e.UseDeviceMotion}))),GD=v.lazy(()=>N(()=>import("./UseDeviceOrientation-CCoM2DSk.js"),__vite__mapDeps([12,3])).then(e=>({default:"default"in e?e.default:e.UseDeviceOrientation}))),KD=v.lazy(()=>N(()=>import("./UseDialogBox-Xwn-tg9k.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseDialogBox}))),QD=v.lazy(()=>N(()=>import("./UseDisplayMedia-469rYDH9.js"),__vite__mapDeps([13,14,15,3])).then(e=>({default:"default"in e?e.default:e.UseDisplayMedia}))),YD=v.lazy(()=>N(()=>import("./UseDocumentPIP-IOlpBuYS.js"),__vite__mapDeps([16,17,15])).then(e=>({default:"default"in e?e.default:e.UseDocumentPIP}))),JD=v.lazy(()=>N(()=>import("./UseEyeDropper-MfgzIEyQ.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseEyeDropper}))),XD=v.lazy(()=>N(()=>import("./UseFPS-__tFhHnq.js"),__vite__mapDeps([18,19,15])).then(e=>({default:"default"in e?e.default:e.UseFPS}))),ZD=v.lazy(()=>N(()=>import("./UseFetch-nvmogrrO.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseFetch}))),e6=v.lazy(()=>N(()=>import("./UseFullscreen-XqgvLcYP.js"),__vite__mapDeps([20,3])).then(e=>({default:"default"in e?e.default:e.UseFullscreen}))),t6=v.lazy(()=>N(()=>import("./UseGeolocation-0pgx1KL3.js"),__vite__mapDeps([21,3])).then(e=>({default:"default"in e?e.default:e.UseGeolocation}))),n6=v.lazy(()=>N(()=>import("./UseIdleCallback-w2V7XGmh.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseIdleCallback}))),o6=v.lazy(()=>N(()=>import("./UseInterval-Z6uQjR2s.js"),__vite__mapDeps([22,23])).then(e=>({default:"default"in e?e.default:e.UseInterval}))),r6=v.lazy(()=>N(()=>import("./UseLock-Y7a-dOLm.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseLock}))),a6=v.lazy(()=>N(()=>import("./UseMediaDevices-VT7PW5nj.js"),__vite__mapDeps([24,14,15])).then(e=>({default:"default"in e?e.default:e.UseMediaDevices}))),i6=v.lazy(()=>N(()=>import("./UseMediaQuery-7AW3gPcc.js"),__vite__mapDeps([25,26,3])).then(e=>({default:"default"in e?e.default:e.UseMediaQuery}))),l6=v.lazy(()=>N(()=>import("./UsePIP-Y2L8hgfZ.js"),__vite__mapDeps([27,28])).then(e=>({default:"default"in e?e.default:e.UsePIP}))),s6=v.lazy(()=>N(()=>import("./UsePermission-zbllwW88.js"),__vite__mapDeps([29,3])).then(e=>({default:"default"in e?e.default:e.UsePermission}))),c6=v.lazy(()=>N(()=>import("./UsePopover-TgKTz30u.js"),__vite__mapDeps([30,31,32,3])).then(e=>({default:"default"in e?e.default:e.UsePopover}))),u6=v.lazy(()=>N(()=>import("./UsePromiseSuspensible-4e5FrDhj.js"),__vite__mapDeps([33,1,15,34])).then(e=>({default:"default"in e?e.default:e.UsePromiseSuspensible}))),d6=v.lazy(()=>N(()=>import("./UsePublishSubscribe-r-K3-rvK.js"),__vite__mapDeps([35,36])).then(e=>({default:"default"in e?e.default:e.UsePublishSubscribe}))),p6=v.lazy(()=>N(()=>import("./UseRaf-9TZjfXAO.js"),__vite__mapDeps([37,19,38,15])).then(e=>({default:"default"in e?e.default:e.UseRaf}))),f6=v.lazy(()=>N(()=>import("./UseReducedMotion-NBseqg_f.js"),__vite__mapDeps([39,40,26,3])).then(e=>({default:"default"in e?e.default:e.UseReducedMotion}))),h6=v.lazy(()=>N(()=>import("./UseRemotePlayback-VYNTVeQf.js"),__vite__mapDeps([41,28,3])).then(e=>({default:"default"in e?e.default:e.UseRemotePlayback}))),m6=v.lazy(()=>N(()=>import("./UseScreenWakeLock-PIFz5lTt.js"),__vite__mapDeps([42,3])).then(e=>({default:"default"in e?e.default:e.UseScreenWakeLock}))),g6=v.lazy(()=>N(()=>import("./UseScript-7qtJcAEN.js"),__vite__mapDeps([43,44,15,3])).then(e=>({default:"default"in e?e.default:e.UseScript}))),_6=v.lazy(()=>N(()=>import("./UseShare-IMSQRe3g.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseShare}))),b6=v.lazy(()=>N(()=>import("./UseSpeechRecognition-ysLPqBBa.js"),__vite__mapDeps([45,46,3,15])).then(e=>({default:"default"in e?e.default:e.UseSpeechRecognition}))),v6=v.lazy(()=>N(()=>import("./UseSpeechSynthesis-weXaSUwd.js"),__vite__mapDeps([47,3])).then(e=>({default:"default"in e?e.default:e.UseSpeechSynthesis}))),y6=v.lazy(()=>N(()=>import("./UseTextSelection-S2HvQcNx.js"),__vite__mapDeps([48,3,34])).then(e=>({default:"default"in e?e.default:e.UseTextSelection}))),k6=v.lazy(()=>N(()=>import("./UseThrottle-ygPP4Ab7.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseThrottle}))),w6=v.lazy(()=>N(()=>import("./UseTimeout-oJ0wk_in.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseTimeout}))),S6=v.lazy(()=>N(()=>import("./UseTitle-KyQuh-Cq.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseTitle}))),x6=v.lazy(()=>N(()=>import("./UseVibrate-9-Oa6lcC.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseVibrate}))),C6=v.lazy(()=>N(()=>import("./UseVideo--9VRdeov.js"),__vite__mapDeps([49,28,5])).then(e=>({default:"default"in e?e.default:e.UseVideo}))),E6=v.lazy(()=>N(()=>import("./UseWebWorker-BN2DxxNv.js"),__vite__mapDeps([50,15])).then(e=>({default:"default"in e?e.default:e.UseWebWorker}))),T6=v.lazy(()=>N(()=>import("./UseWebWorkerFn-BLKjGiWH.js"),__vite__mapDeps([51,15])).then(e=>({default:"default"in e?e.default:e.UseWebWorkerFn}))),A6=v.lazy(()=>N(()=>import("./UseBeforeUnload-zCCkYCIe.js"),__vite__mapDeps([52,53,54])).then(e=>({default:"default"in e?e.default:e.UseBeforeUnload}))),P6=v.lazy(()=>N(()=>import("./UseClickOutside-Sr5RAu0W.js"),__vite__mapDeps([55,53,54])).then(e=>({default:"default"in e?e.default:e.UseClickOutside}))),R6=v.lazy(()=>N(()=>import("./UseContextMenu-1LqG2ATf.js"),__vite__mapDeps([56,53,54])).then(e=>({default:"default"in e?e.default:e.UseContextMenu}))),M6=v.lazy(()=>N(()=>import("./UseDocumentVisibility-4SFi77yE.js"),__vite__mapDeps([57,3])).then(e=>({default:"default"in e?e.default:e.UseDocumentVisibility}))),j6=v.lazy(()=>N(()=>import("./UseDoubleClick-KQHoXKA9.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseDoubleClick}))),D6=v.lazy(()=>N(()=>import("./UseEventDispatcher-NAE-0XoH.js"),__vite__mapDeps([58,54,53])).then(e=>({default:"default"in e?e.default:e.UseEventDispatcher}))),z6=v.lazy(()=>N(()=>import("./UseEventListener-ubCPCn1F.js"),__vite__mapDeps([59,53,54])).then(e=>({default:"default"in e?e.default:e.UseEventListener}))),O6=v.lazy(()=>N(()=>import("./UseEvents-TSARYaKc.js"),__vite__mapDeps([60,61])).then(e=>({default:"default"in e?e.default:e.UseEvents}))),L6=v.lazy(()=>N(()=>import("./UseHotKeys-a_zDnGjU.js"),__vite__mapDeps([62,53,54])).then(e=>({default:"default"in e?e.default:e.UseHotKeys}))),I6=v.lazy(()=>N(()=>import("./UseHover-zde5C5OG.js"),__vite__mapDeps([63,3])).then(e=>({default:"default"in e?e.default:e.UseHover}))),F6=v.lazy(()=>N(()=>import("./UseInfiniteScroll-K1nYu_vT.js"),__vite__mapDeps([64,3])).then(e=>({default:"default"in e?e.default:e.UseInfiniteScroll}))),U6=v.lazy(()=>N(()=>import("./UseIntersectionObserver-1iyhPOGF.js"),__vite__mapDeps([65,15])).then(e=>({default:"default"in e?e.default:e.UseIntersectionObserver}))),N6=v.lazy(()=>N(()=>import("./UseIsOnline-Me4db5Kb.js"),__vite__mapDeps([66,67,3])).then(e=>({default:"default"in e?e.default:e.UseIsOnline}))),H6=v.lazy(()=>N(()=>import("./UseLongPress-7inrAPgx.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseLongPress}))),W6=v.lazy(()=>N(()=>import("./UseMeasure-MxY5Hkio.js"),__vite__mapDeps([68,38,15])).then(e=>({default:"default"in e?e.default:e.UseMeasure}))),B6=v.lazy(()=>N(()=>import("./UseMouse--sYIEUxL.js"),__vite__mapDeps([69,3])).then(e=>({default:"default"in e?e.default:e.UseMouse}))),V6=v.lazy(()=>N(()=>import("./UseMutationObserver-Vwjgp3kK.js"),__vite__mapDeps([70,15])).then(e=>({default:"default"in e?e.default:e.UseMutationObserver}))),$6=v.lazy(()=>N(()=>import("./UseNetwork-huNE6fg7.js"),__vite__mapDeps([71,67,3])).then(e=>({default:"default"in e?e.default:e.UseNetwork}))),q6=v.lazy(()=>N(()=>import("./UsePerformAction-lcJHuzdw.js"),__vite__mapDeps([72,46,44,15,3])).then(e=>({default:"default"in e?e.default:e.UsePerformAction}))),G6=v.lazy(()=>N(()=>import("./UsePinchZoom-lOd1sT4a.js"),__vite__mapDeps([73,53,54])).then(e=>({default:"default"in e?e.default:e.UsePinchZoom}))),K6=v.lazy(()=>N(()=>import("./UsePointerLock-3GvGYBCg.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UsePointerLock}))),Q6=v.lazy(()=>N(()=>import("./UseResizeObserver-0CldWO_G.js"),__vite__mapDeps([74,38,15])).then(e=>({default:"default"in e?e.default:e.UseResizeObserver}))),Y6=v.lazy(()=>N(()=>import("./UseResponsive-33WEZJ8F.js"),__vite__mapDeps([75,3])).then(e=>({default:"default"in e?e.default:e.UseResponsive}))),J6=v.lazy(()=>N(()=>import("./UseScreen-Rqt5ULlH.js"),__vite__mapDeps([76,3])).then(e=>({default:"default"in e?e.default:e.UseScreen}))),X6=v.lazy(()=>N(()=>import("./UseScrollIntoView-J_6yfPhX.js"),__vite__mapDeps([77,53,54,40,26,3])).then(e=>({default:"default"in e?e.default:e.UseScrollIntoView}))),Z6=v.lazy(()=>N(()=>import("./UseSwipe-nkD0KiN-.js"),__vite__mapDeps([78,53,54])).then(e=>({default:"default"in e?e.default:e.UseSwipe}))),ez=v.lazy(()=>N(()=>import("./UseVisible-nMPa9p1z.js"),__vite__mapDeps([79,15,3])).then(e=>({default:"default"in e?e.default:e.UseVisible}))),tz=v.lazy(()=>N(()=>import("./UseEffectCompare-03dOOppE.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseEffectCompare}))),nz=v.lazy(()=>N(()=>import("./UseEffectDeepCompare-dQFMWyLp.js"),__vite__mapDeps([80,34])).then(e=>({default:"default"in e?e.default:e.UseEffectDeepCompare}))),oz=v.lazy(()=>N(()=>import("./UseEffectOnce-0wP15sfY.js"),__vite__mapDeps([81,15])).then(e=>({default:"default"in e?e.default:e.UseEffectOnce}))),rz=v.lazy(()=>N(()=>import("./UseIsMounted-Huo70Hxu.js"),__vite__mapDeps([82,15])).then(e=>({default:"default"in e?e.default:e.UseIsMounted}))),az=v.lazy(()=>N(()=>import("./UseLogger-GBbtZNdt.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseLogger}))),iz=v.lazy(()=>N(()=>import("./UseRerender-BPRGDK6C.js"),__vite__mapDeps([83,17])).then(e=>({default:"default"in e?e.default:e.UseRerender}))),lz=v.lazy(()=>N(()=>import("./UseCallbackCompare-sXI48KSi.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseCallbackCompare}))),sz=v.lazy(()=>N(()=>import("./UseCallbackDeepCompare-17OmDGGT.js"),__vite__mapDeps([84,34])).then(e=>({default:"default"in e?e.default:e.UseCallbackDeepCompare}))),cz=v.lazy(()=>N(()=>import("./UseLazyRef-tgq5yOn1.js"),__vite__mapDeps([85,17,23,31])).then(e=>({default:"default"in e?e.default:e.UseLazyRef}))),uz=v.lazy(()=>N(()=>import("./UseMemoCompare-n5jiEdJ0.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseMemoCompare}))),dz=v.lazy(()=>N(()=>import("./UseMemoDeepCompare-2PGpNzIw.js"),__vite__mapDeps([86,34])).then(e=>({default:"default"in e?e.default:e.UseMemoDeepCompare}))),pz=v.lazy(()=>N(()=>import("./UseMemoizedFn-_ILHoUV2.js"),__vite__mapDeps([87,54])).then(e=>({default:"default"in e?e.default:e.UseMemoizedFn}))),fz=v.lazy(()=>N(()=>import("./UseMergedRef-sUopZ0vb.js"),__vite__mapDeps([88,38,15,32])).then(e=>({default:"default"in e?e.default:e.UseMergedRef}))),hz=v.lazy(()=>N(()=>import("./CreatePubSubStore-IpsgnUSf.js"),__vite__mapDeps([89,3,36,31,34])).then(e=>({default:"default"in e?e.default:e.CreatePubSubStore}))),mz=v.lazy(()=>N(()=>import("./UseArray-1Q2rDcVz.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseArray}))),gz=v.lazy(()=>N(()=>import("./UseDerivedState--c-9t8C1.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseDerivedState}))),_z=v.lazy(()=>N(()=>import("./UseLocalStorageState-BGQhUwDA.js"),__vite__mapDeps([90,61,54,15])).then(e=>({default:"default"in e?e.default:e.UseLocalStorageState}))),bz=v.lazy(()=>N(()=>import("./UseMap-zT0mYnHo.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseMap}))),vz=v.lazy(()=>N(()=>import("./UsePrevious-OP9igIAZ.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UsePrevious}))),yz=v.lazy(()=>N(()=>import("./UseProxyState-RkEIVXCu.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseProxyState}))),kz=v.lazy(()=>N(()=>import("./UseSessionStorageState-wf2GAP0J.js"),__vite__mapDeps([91,61,54])).then(e=>({default:"default"in e?e.default:e.UseSessionStorageState}))),wz=v.lazy(()=>N(()=>import("./UseSet-sI2_V5RK.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseSet}))),Sz=v.lazy(()=>N(()=>import("./UseStateGetReset-yI2IFHyw.js"),__vite__mapDeps([92,54])).then(e=>({default:"default"in e?e.default:e.UseStateGetReset}))),xz=v.lazy(()=>N(()=>import("./UseStateHistory-R6BCybzx.js"),__vite__mapDeps([])).then(e=>({default:"default"in e?e.default:e.UseStateHistory}))),Cz=v.lazy(()=>N(()=>import("./UseStateValidator-ohhMfQYr.js"),__vite__mapDeps([93,54])).then(e=>({default:"default"in e?e.default:e.UseStateValidator})));function Ez(){const e=J1([{path:"/",element:u.jsx(wS,{}),children:[{index:!0,element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(MD,{})})},{path:"hooks",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(En,{})}),children:[{index:!0,element:u.jsx(pn,{to:"/hooks/state/createPubSubStore",replace:!0})},{path:"state",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(En,{})}),children:[{index:!0,element:u.jsx(pn,{to:"/createPubSubStore",replace:!0})},{path:"createPubSubStore",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:aj,component:u.jsx(hz,{})})})},{path:"useArray",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:xj,component:u.jsx(mz,{})})})},{path:"useDerivedState",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Fj,component:u.jsx(gz,{})})})},{path:"useLocalStorageState",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:_9,component:u.jsx(_z,{})})})},{path:"useMap",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:k9,component:u.jsx(bz,{})})})},{path:"usePrevious",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:F9,component:u.jsx(vz,{})})})},{path:"useProxyState",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:N9,component:u.jsx(yz,{})})})},{path:"useReducerGetReset",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:V9})})},{path:"useReducerHistory",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:$9})})},{path:"useReducerHistoryGetter",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:q9})})},{path:"useSessionStorageState",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:tD,component:u.jsx(kz,{})})})},{path:"useSet",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:nD,component:u.jsx(wz,{})})})},{path:"useStateGetReset",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:iD,component:u.jsx(Sz,{})})})},{path:"useStateHistory",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:lD,component:u.jsx(xz,{})})})},{path:"useStateHistoryGetter",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:sD})})},{path:"useStateValidator",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:cD,component:u.jsx(Cz,{})})})},{path:"useSyncExternalStore",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:dD})})}]},{path:"lifecycle",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(En,{})}),children:[{index:!0,element:u.jsx(pn,{to:"/useDeferredValue",replace:!0})},{path:"useDeferredValue",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Ij})})},{path:"useEffectCompare",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:qj,component:u.jsx(tz,{})})})},{path:"useEffectDeepCompare",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Gj,component:u.jsx(nz,{})})})},{path:"useEffectOnce",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Kj,component:u.jsx(oz,{})})})},{path:"useIsMounted",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:d9,component:u.jsx(rz,{})})})},{path:"useLayoutEffectCompare",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:f9})})},{path:"useLayoutEffectDeepCompare",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:h9})})},{path:"useLayoutEffectOnce",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:m9})})},{path:"useLogger",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:v9,component:u.jsx(az,{})})})},{path:"useRerender",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:K9,component:u.jsx(iz,{})})})}]},{path:"performance",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(En,{})}),children:[{index:!0,element:u.jsx(pn,{to:"/useCallbackCompare",replace:!0})},{path:"useCallbackCompare",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Rj,component:u.jsx(lz,{})})})},{path:"useCallbackDeepCompare",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Mj,component:u.jsx(sz,{})})})},{path:"useId",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:i9})})},{path:"useLazyRef",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:g9,component:u.jsx(cz,{})})})},{path:"useMemoCompare",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:C9,component:u.jsx(uz,{})})})},{path:"useMemoDeepCompare",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:E9,component:u.jsx(dz,{})})})},{path:"useMemoizedFn",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:T9,component:u.jsx(pz,{})})})},{path:"useMergedRef",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:A9,component:u.jsx(fz,{})})})}]},{path:"events",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(En,{})}),children:[{index:!0,element:u.jsx(pn,{to:"/useBeforeUnload",replace:!0})},{path:"useBeforeUnload",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Tj,component:u.jsx(A6,{})})})},{path:"useClickOutside",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:jj,component:u.jsx(P6,{})})})},{path:"useContextMenu",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Oj,component:u.jsx(R6,{})})})},{path:"useDocumentVisibility",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Vj,component:u.jsx(M6,{})})})},{path:"useDoubleClick",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:$j,component:u.jsx(j6,{})})})},{path:"useEventDispatcher",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Qj,component:u.jsx(D6,{})})})},{path:"useEventListener",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Yj,component:u.jsx(z6,{})})})},{path:"useEvents",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Xj,component:u.jsx(O6,{})})})},{path:"useHotKeys",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:r9,component:u.jsx(L6,{})})})},{path:"useHover",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:a9,component:u.jsx(I6,{})})})},{path:"useInfiniteScroll",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:s9,component:u.jsx(F6,{})})})},{path:"useIntersectionObserver",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:c9,component:u.jsx(U6,{})})})},{path:"useIsOnline",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:p9,component:u.jsx(N6,{})})})},{path:"useLongPress",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:y9,component:u.jsx(H6,{})})})},{path:"useMeasure",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:w9,component:u.jsx(W6,{})})})},{path:"useMouse",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:P9,component:u.jsx(B6,{})})})},{path:"useMutationObserver",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:R9,component:u.jsx(V6,{})})})},{path:"useNetwork",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:M9,component:u.jsx($6,{})})})},{path:"usePerformAction",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:D9,component:u.jsx(q6,{})})})},{path:"usePinchZoom",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:O9,component:u.jsx(G6,{})})})},{path:"usePointerLock",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:L9,component:u.jsx(K6,{})})})},{path:"useResizeObserver",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Q9,component:u.jsx(Q6,{})})})},{path:"useResponsive",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Y9,component:u.jsx(Y6,{})})})},{path:"useScreen",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:J9,component:u.jsx(J6,{})})})},{path:"useScrollIntoView",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:eD,component:u.jsx(X6,{})})})},{path:"useSwipe",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:uD,component:u.jsx(Z6,{})})})},{path:"useVisible",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:bD,component:u.jsx(ez,{})})})}]},{path:"api-dom",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(En,{})}),children:[{index:!0,element:u.jsx(pn,{to:"/useActiveElement",replace:!0})},{path:"useActiveElement",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:wj,component:u.jsx(ID,{})})})},{path:"useAnimation",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Sj,component:u.jsx(FD,{})})})},{path:"useAudio",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Cj,component:u.jsx(UD,{})})})},{path:"useBattery",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Ej,component:u.jsx(ND,{})})})},{path:"useBluetooth",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Aj,component:u.jsx(HD,{})})})},{path:"useBroadcastChannel",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Pj,component:u.jsx(WD,{})})})},{path:"useClipboard",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Dj,component:u.jsx(BD,{})})})},{path:"useColorScheme",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:zj,component:u.jsx(VD,{})})})},{path:"useDebounce",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Lj,component:u.jsx($D,{})})})},{path:"useDeviceMotion",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Uj,component:u.jsx(qD,{})})})},{path:"useDeviceOrientation",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Nj,component:u.jsx(GD,{})})})},{path:"useDialogBox",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Hj,component:u.jsx(KD,{})})})},{path:"useDisplayMedia",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Wj,component:u.jsx(QD,{})})})},{path:"useDocumentPIP",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Bj,component:u.jsx(YD,{})})})},{path:"useEventSource",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Jj})})},{path:"useEyeDropper",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Zj,component:u.jsx(JD,{})})})},{path:"useFetch",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:t9,component:u.jsx(ZD,{})})})},{path:"useFPS",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:e9,component:u.jsx(XD,{})})})},{path:"useFullscreen",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:n9,component:u.jsx(e6,{})})})},{path:"useGeolocation",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:o9,component:u.jsx(t6,{})})})},{path:"useIdleCallback",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:l9,component:u.jsx(n6,{})})})},{path:"useInterval",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:u9,component:u.jsx(o6,{})})})},{path:"useLock",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:b9,component:u.jsx(r6,{})})})},{path:"useMediaDevices",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:S9,component:u.jsx(a6,{})})})},{path:"useMediaQuery",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:x9,component:u.jsx(i6,{})})})},{path:"usePermission",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:z9,component:u.jsx(s6,{})})})},{path:"usePIP",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:j9,component:u.jsx(l6,{})})})},{path:"usePopover",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:I9,component:u.jsx(c6,{})})})},{path:"usePromiseSuspensible",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:U9,component:u.jsx(u6,{})})})},{path:"usePublishSubscribe",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:H9,component:u.jsx(d6,{})})})},{path:"useRaf",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:W9,component:u.jsx(p6,{})})})},{path:"useReducedMotion",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:B9,component:u.jsx(f6,{})})})},{path:"useRemotePlayback",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:G9,component:u.jsx(h6,{})})})},{path:"useScreenWakeLock",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:X9,component:u.jsx(m6,{})})})},{path:"useScript",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:Z9,component:u.jsx(g6,{})})})},{path:"useShare",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:oD,component:u.jsx(_6,{})})})},{path:"useSpeechRecognition",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:rD,component:u.jsx(b6,{})})})},{path:"useSpeechSynthesis",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:aD,component:u.jsx(v6,{})})})},{path:"useTextSelection",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:pD,component:u.jsx(y6,{})})})},{path:"useThrottle",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:fD,component:u.jsx(k6,{})})})},{path:"useTimeout",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:hD,component:u.jsx(w6,{})})})},{path:"useTitle",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:mD,component:u.jsx(S6,{})})})},{path:"useVibrate",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:gD,component:u.jsx(x6,{})})})},{path:"useVideo",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:_D,component:u.jsx(C6,{})})})},{path:"useWebSocket",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:vD})})},{path:"useWebWorker",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:yD,component:u.jsx(E6,{})})})},{path:"useWebWorkerFn",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:kD,component:u.jsx(T6,{})})})}]}]},{path:"components",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(En,{})}),children:[{index:!0,element:u.jsx(pn,{to:"/components/ErrorBoundary",replace:!0})},{path:"ErrorBoundary",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:KM,component:u.jsx(jD,{})})})},{path:"For",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:QM,component:u.jsx(DD,{})})})},{path:"ForMemoized",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:YM})})},{path:"LazyComponent",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:JM,component:u.jsx(zD,{})})})},{path:"Show",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:XM,component:u.jsx(OD,{})})})},{path:"ShowMemoized",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:ZM})})},{path:"SwitchCase",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:ej,component:u.jsx(LD,{})})})},{path:"SwitchCaseMemoized",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:tj})})}]},{path:"utils",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(En,{})}),children:[{index:!0,element:u.jsx(pn,{to:"/utils/alphanumericCompare",replace:!0})},{path:"alphanumericCompare",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:nj})})},{path:"changeStringCase",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:oj})})},{path:"clickElementOnKeydownEvent",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:rj})})},{path:"defaultSerializer",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:ij})})},{path:"detectBrowser",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:lj})})},{path:"getBase64",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:sj})})},{path:"getKeyObjectFromValue",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:cj})})},{path:"getObjectFromDottedString",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:uj})})},{path:"hotKeyHandler",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:dj})})},{path:"isAsync",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:pj})})},{path:"isClient",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:fj})})},{path:"isDeepEqual",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:hj})})},{path:"isMouseEvent",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:mj})})},{path:"isShallowEqual",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:gj})})},{path:"isTouchEvent",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:_j})})},{path:"lazy",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:bj})})},{path:"mergeObjects",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:vj})})},{path:"removePropertiesFromArrayObjects",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:yj})})},{path:"uniqueElementsArray",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:kj})})}]},{path:"types",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(En,{})}),children:[{index:!0,element:u.jsx(pn,{to:"/types/utilityTypes",replace:!0})},{path:"utilityTypes",element:u.jsx(v.Suspense,{fallback:u.jsx(j,{}),children:u.jsx(O,{markdown:wD})})}]}]}]);return u.jsx(iS,{router:e})}function Tz(){return u.jsx(Ez,{})}Kc.createRoot(document.getElementById("root")).render(u.jsx(v.StrictMode,{children:u.jsx(Tz,{})}));export{N as _,ep as a,u as j,v as r};
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/ErrorBoundary--1zq4UoE.js","assets/ErrorBoundary-nJrHRy0C.js","assets/UseActiveElement-2hjKditX.js","assets/useSyncExternalStore-M_JOufMx.js","assets/UseAudio-QsTm0209.js","assets/createHTMLMediaElement-woNbkg4_.js","assets/UseBattery-7XQZkJgL.js","assets/UseBluetooth-tNzVV7Ez.js","assets/UseBroadcastChannel-KTyZA0W6.js","assets/UseClipboard-7pNf1DGX.js","assets/UseColorScheme-CzpGbyvT.js","assets/UseDeviceMotion-Tquk0Bcy.js","assets/UseDeviceOrientation-CCoM2DSk.js","assets/UseDisplayMedia-469rYDH9.js","assets/useMediaDevices-RlzmHcYA.js","assets/useEffectOnce-4eMXf9_f.js","assets/UseDocumentPIP-IOlpBuYS.js","assets/useRerender-4KZNMJEZ.js","assets/UseFPS-__tFhHnq.js","assets/useRaf-VOHa-bu1.js","assets/UseFullscreen-XqgvLcYP.js","assets/UseGeolocation-0pgx1KL3.js","assets/UseInterval-Z6uQjR2s.js","assets/useInterval-2L3Zo1e3.js","assets/UseMediaDevices-VT7PW5nj.js","assets/UseMediaQuery-7AW3gPcc.js","assets/useMediaQuery-s5MtG8Mu.js","assets/UsePIP-Y2L8hgfZ.js","assets/mov_bbb-wTtoEAf2.js","assets/UsePermission-zbllwW88.js","assets/UsePopover-TgKTz30u.js","assets/useLazyRef-Kn2kuKeg.js","assets/useMergedRef-ULL3cy1f.js","assets/UsePromiseSuspensible-4e5FrDhj.js","assets/isDeepEqual-miY4iMQs.js","assets/UsePublishSubscribe-r-K3-rvK.js","assets/PublishSubscribePattern-aUbEeFKT.js","assets/UseRaf-9TZjfXAO.js","assets/useResizeObserver-0TDGBVwo.js","assets/UseReducedMotion-NBseqg_f.js","assets/useReducedMotion-Lrh9VHzb.js","assets/UseRemotePlayback-VYNTVeQf.js","assets/UseScreenWakeLock-PIFz5lTt.js","assets/UseScript-7qtJcAEN.js","assets/useScript-cYBRfkuv.js","assets/UseSpeechRecognition-ysLPqBBa.js","assets/usePerformAction-B0dMZpB7.js","assets/UseSpeechSynthesis-weXaSUwd.js","assets/UseTextSelection-S2HvQcNx.js","assets/UseVideo--9VRdeov.js","assets/UseWebWorker-BN2DxxNv.js","assets/UseWebWorkerFn-BLKjGiWH.js","assets/UseBeforeUnload-zCCkYCIe.js","assets/useEventListener-8Qo_FdZ-.js","assets/useMemoizedFn-bjVdXuNt.js","assets/UseClickOutside-Sr5RAu0W.js","assets/UseContextMenu-1LqG2ATf.js","assets/UseDocumentVisibility-4SFi77yE.js","assets/UseEventDispatcher-NAE-0XoH.js","assets/UseEventListener-ubCPCn1F.js","assets/UseEvents-TSARYaKc.js","assets/useEvents-qrpK7jNW.js","assets/UseHotKeys-a_zDnGjU.js","assets/UseHover-zde5C5OG.js","assets/UseInfiniteScroll-K1nYu_vT.js","assets/UseIntersectionObserver-1iyhPOGF.js","assets/UseIsOnline-Me4db5Kb.js","assets/useNetwork-VpWQ9IsI.js","assets/UseMeasure-MxY5Hkio.js","assets/UseMouse--sYIEUxL.js","assets/UseMutationObserver-Vwjgp3kK.js","assets/UseNetwork-huNE6fg7.js","assets/UsePerformAction-lcJHuzdw.js","assets/UsePinchZoom-lOd1sT4a.js","assets/UseResizeObserver-0CldWO_G.js","assets/UseResponsive-33WEZJ8F.js","assets/UseScreen-Rqt5ULlH.js","assets/UseScrollIntoView-J_6yfPhX.js","assets/UseSwipe-nkD0KiN-.js","assets/UseVisible-nMPa9p1z.js","assets/UseEffectDeepCompare-dQFMWyLp.js","assets/UseEffectOnce-0wP15sfY.js","assets/UseIsMounted-Huo70Hxu.js","assets/UseRerender-BPRGDK6C.js","assets/UseCallbackDeepCompare-17OmDGGT.js","assets/UseLazyRef-tgq5yOn1.js","assets/UseMemoDeepCompare-2PGpNzIw.js","assets/UseMemoizedFn-_ILHoUV2.js","assets/UseMergedRef-sUopZ0vb.js","assets/CreatePubSubStore-IpsgnUSf.js","assets/UseLocalStorageState-BGQhUwDA.js","assets/UseSessionStorageState-wf2GAP0J.js","assets/UseStateGetReset-yI2IFHyw.js","assets/UseStateValidator-ohhMfQYr.js"]
  }
